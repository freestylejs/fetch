...
export type SubscriptionsResourceBillingSchedulesAppliesToModel = {
  'price': string | PriceModel;
  'type': 'price';
};

export type SubscriptionsResourceBillingSchedulesModel = {
  'applies_to': SubscriptionsResourceBillingSchedulesAppliesToModel[];
  'bill_until': SubscriptionsResourceBillingSchedulesBillUntilModel;
  'key': string;
};
...
'specified_commercial_transactions_act_url': z.string().optional(),
...
'automatic_indirect_tax': z.enum(['active', 'inactive', 'pending']).optional(),
...
'gopay_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'grabpay_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'id_bank_transfer_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'id_bank_transfer_payments_bca': z.enum(['active', 'inactive', 'pending']).optional(),
...
'paypal_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'paypay_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'payto_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'pix_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'promptpay_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'qris_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'rechnung_payments': z.enum(['active', 'inactive', 'pending']).optional(),
...
'shopeepay_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'sofort_payments': z.enum(['active', 'inactive', 'pending']).optional(),
'stripe_balance_payments': z.enum(['active', 'inactive', 'pending']).optional(),
...
'treasury_evolve': z.enum(['active', 'inactive', 'pending']).optional(),
'treasury_fifth_third': z.enum(['active', 'inactive', 'pending']).optional(),
'treasury_goldman_sachs': z.enum(['active', 'inactive', 'pending']).optional(),
...
export const AccountUnificationAccountControllerApplication = z.object({
'loss_liable': z.boolean(),
'onboarding_owner': z.boolean(),
'pricing_controls': z.boolean()
});

export type AccountUnificationAccountControllerApplicationModel = z.infer<typeof AccountUnificationAccountControllerApplication>;

export const AccountUnificationAccountControllerDashboard = z.object({
'type': z.enum(['express', 'full', 'none'])
});

export type AccountUnificationAccountControllerDashboardModel = z.infer<typeof AccountUnificationAccountControllerDashboard>;

export const AccountUnificationAccountControllerFees = z.object({
'payer': z.enum(['account', 'application', 'application_custom', 'application_express', 'application_unified_accounts_beta'])
});
...
'application': AccountUnificationAccountControllerApplication.optional(),
'dashboard': AccountUnificationAccountControllerDashboard.optional(),
...
export const SourceTypePaypal = z.object({
'billing_agreement': z.string().optional(),
'fingerprint': z.string().optional(),
'payer_id': z.string().optional(),
'reference_id': z.string().optional(),
'reference_transaction_amount': z.string().optional(),
'reference_transaction_charged': z.boolean().optional(),
'statement_descriptor': z.string().optional(),
'transaction_id': z.string().optional(),
'verified_email': z.string().optional()
});

export type SourceTypePaypalModel = z.infer<typeof SourceTypePaypal>;
...
'paypal': SourceTypePaypal.optional(),
...
'type': z.enum(['ach_credit_transfer', 'ach_debit', 'acss_debit', 'alipay', 'au_becs_debit', 'bancontact', 'card', 'card_present', 'eps', 'giropay', 'ideal', 'klarna', 'multibanco', 'p24', 'paypal', 'sepa_credit_transfer', 'sepa_debit', 'sofort', 'three_d_secure', 'wechat']),
'usage': z.string(),
...
export type ScriptModel = z.infer<typeof Script>;
...
'script': z.union([Script]).optional(),
'times_redeemed': z.number().int(),
'type': z.enum(['amount_off', 'percent_off', 'script']).optional(),
'valid': z.boolean()
});
...
export const MandatePayto = z.object({
'amount': z.number().int(),
'amount_type': z.enum(['fixed', 'maximum']),
'end_date': z.string(),
'payment_schedule': z.enum(['adhoc', 'annual', 'daily', 'fortnightly', 'monthly', 'quarterly', 'semi_annual', 'weekly']),
'payments_per_period': z.number().int(),
'purpose': z.enum(['dependant_support', 'government', 'loan', 'mortgage', 'other', 'pension', 'personal', 'retail', 'salary', 'tax', 'utility']),
'start_date': z.string()
});

export type MandatePaytoModel = z.infer<typeof MandatePayto>;

export const MandatePix = z.object({
'amount_includes_iof': z.enum(['always', 'never']).optional(),
'amount_type': z.enum(['fixed', 'maximum']).optional(),
'end_date': z.string().optional(),
'payment_schedule': z.enum(['halfyearly', 'monthly', 'quarterly', 'weekly', 'yearly']).optional(),
'reference': z.string().optional(),
'start_date': z.string().optional()
});

export type MandatePixModel = z.infer<typeof MandatePix>;
...
'payto': MandatePayto.optional(),
'pix': MandatePix.optional(),
...
export const SetupAttemptPaymentMethodDetailsIdBankTransfer = z.object({
'bank': z.enum(['bca', 'bni', 'bri', 'cimb', 'permata']),
'bank_code': z.string(),
'bank_name': z.string(),
'display_name': z.string()
});

export type SetupAttemptPaymentMethodDetailsIdBankTransferModel = z.infer<typeof SetupAttemptPaymentMethodDetailsIdBankTransfer>;
...
export const SetupAttemptPaymentMethodDetailsPayto = z.object({

});

export type SetupAttemptPaymentMethodDetailsPaytoModel = z.infer<typeof SetupAttemptPaymentMethodDetailsPayto>;

export const SetupAttemptPaymentMethodDetailsPix = z.object({

});

export type SetupAttemptPaymentMethodDetailsPixModel = z.infer<typeof SetupAttemptPaymentMethodDetailsPix>;
...
export const SetupAttemptPaymentMethodDetailsStripeBalance = z.object({

});

export type SetupAttemptPaymentMethodDetailsStripeBalanceModel = z.infer<typeof SetupAttemptPaymentMethodDetailsStripeBalance>;
...
'id_bank_transfer': SetupAttemptPaymentMethodDetailsIdBankTransfer.optional(),
...
'payto': SetupAttemptPaymentMethodDetailsPayto.optional(),
'pix': SetupAttemptPaymentMethodDetailsPix.optional(),
...
'stripe_balance': SetupAttemptPaymentMethodDetailsStripeBalance.optional(),
'type': z.string(),
...
export const RefundDestinationDetailsIdBankTransfer = z.object({
'reference': z.string(),
'reference_status': z.string()
});

export type RefundDestinationDetailsIdBankTransferModel = z.infer<typeof RefundDestinationDetailsIdBankTransfer>;
...
'id_bank_transfer': RefundDestinationDetailsIdBankTransfer.optional(),
...
'submission_method': z.enum(['manual', 'not_submitted', 'smart_disputes']).optional()
});
...
export const DisputeSmartDisputes = z.object({
'recommended_evidence': z.array(z.array(z.string())),
'status': z.enum(['available', 'processing', 'requires_evidence', 'unavailable'])
});

export type DisputeSmartDisputesModel = z.infer<typeof DisputeSmartDisputes>;
...
'id': z.string(),
'intended_submission_method': z.enum(['manual', 'prefer_manual', 'prefer_smart_disputes', 'smart_disputes']).optional(),
...
'reason': z.string(),
'smart_disputes': DisputeSmartDisputes.optional(),
...
'other_fees_amount': z.number().int().optional(),
'other_fees_count': z.number().int().optional(),
...
'settlement': z.union([z.string(), IssuingSettlement]).optional(),
...
export const PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesDecrementalAuthorizationDecrementalAuthorization = z.object({
'status': z.enum(['available', 'unavailable'])
});

export type PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesDecrementalAuthorizationDecrementalAuthorizationModel = z.infer<typeof PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesDecrementalAuthorizationDecrementalAuthorization>;
...
export const PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesPartialAuthorizationPartialAuthorization = z.object({
'status': z.enum(['declined', 'fully_authorized', 'not_requested', 'partially_authorized'])
});

export type PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesPartialAuthorizationPartialAuthorizationModel = z.infer<typeof PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesPartialAuthorizationPartialAuthorization>;
...
'amount_authorized': z.number().int(),
'amount_requested': z.number().int().optional(),
'authorization_code': z.string(),
'brand': z.string(),
'capture_before': z.number().int().optional(),
'checks': z.union([PaymentMethodDetailsCardChecks]),
'country': z.string(),
'decremental_authorization': PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesDecrementalAuthorizationDecrementalAuthorization.optional(),
'description': z.string().optional(),
'exp_month': z.number().int(),
'exp_year': z.number().int(),
...
'partial_authorization': PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesPartialAuthorizationPartialAuthorization.optional(),
'regulated_status': z.enum(['regulated', 'unregulated']),
...
export const PaymentMethodDetailsGopay = z.object({

});

export type PaymentMethodDetailsGopayModel = z.infer<typeof PaymentMethodDetailsGopay>;
...
export const PaymentMethodDetailsIdBankTransfer = z.object({
'account_number': z.string(),
'bank': z.enum(['bca', 'bni', 'bri', 'cimb', 'permata']),
'bank_code': z.string().optional(),
'bank_name': z.string().optional(),
...
export type PaymentMethodDetailsIdBankTransferModel = z.infer<typeof PaymentMethodDetailsIdBankTransfer>;
...
'shipping': z.union([Address]).optional(),
'transaction_id': z.string(),
...
export const PaymentMethodDetailsPaypay = z.object({

});

export type PaymentMethodDetailsPaypayModel = z.infer<typeof PaymentMethodDetailsPaypay>;

export const PaymentMethodDetailsPayto = z.object({
'bsb_number': z.string(),
'last4': z.string(),
'mandate': z.string().optional(),
'pay_id': z.string()
...
export type PaymentMethodDetailsPaytoModel = z.infer<typeof PaymentMethodDetailsPayto>;
...
export const PaymentMethodDetailsQris = z.object({

});

export type PaymentMethodDetailsQrisModel = z.infer<typeof PaymentMethodDetailsQris>;

export const PaymentMethodDetailsRechnung = z.object({
'payment_portal_url': z.string()
});

export type PaymentMethodDetailsRechnungModel = z.infer<typeof PaymentMethodDetailsRechnung>;
...
export const PaymentMethodDetailsShopeepay = z.object({

});

export type PaymentMethodDetailsShopeepayModel = z.infer<typeof PaymentMethodDetailsShopeepay>;
...
export const PaymentMethodDetailsStripeBalance = z.object({
'account': z.string().optional(),
'source_type': z.enum(['bank_account', 'card', 'fpx'])
});

export type PaymentMethodDetailsStripeBalanceModel = z.infer<typeof PaymentMethodDetailsStripeBalance>;
...
'gopay': PaymentMethodDetailsGopay.optional(),
'grabpay': PaymentMethodDetailsGrabpay.optional(),
'id_bank_transfer': PaymentMethodDetailsIdBankTransfer.optional(),
...
'paypay': PaymentMethodDetailsPaypay.optional(),
'payto': PaymentMethodDetailsPayto.optional(),
'pix': PaymentMethodDetailsPix.optional(),
'promptpay': PaymentMethodDetailsPromptpay.optional(),
'qris': PaymentMethodDetailsQris.optional(),
'rechnung': PaymentMethodDetailsRechnung.optional(),
...
export const PaymentFlowsPaymentDetailsResourceAffiliate = z.object({
'name': z.string().optional()
});

export type PaymentFlowsPaymentDetailsResourceAffiliateModel = z.infer<typeof PaymentFlowsPaymentDetailsResourceAffiliate>;

export const PaymentFlowsPaymentDetailsResourceDeliveryRecipient = z.object({
'email': z.string().optional(),
'name': z.string().optional(),
'phone': z.string().optional()
});

export type PaymentFlowsPaymentDetailsResourceDeliveryRecipientModel = z.infer<typeof PaymentFlowsPaymentDetailsResourceDeliveryRecipient>;

export const PaymentFlowsPaymentDetailsResourceDelivery = z.object({
'mode': z.enum(['email', 'phone', 'pickup', 'post']).optional(),
'recipient': PaymentFlowsPaymentDetailsResourceDeliveryRecipient.optional()
});

export type PaymentFlowsPaymentDetailsResourceDeliveryModel = z.infer<typeof PaymentFlowsPaymentDetailsResourceDelivery>;

export const PaymentFlowsPaymentDetailsResourceCarRentalDistance = z.object({
'amount': z.number().int().optional(),
'unit': z.string().optional()
});

export type PaymentFlowsPaymentDetailsResourceCarRentalDistanceModel = z.infer<typeof PaymentFlowsPaymentDetailsResourceCarRentalDistance>;

export const PaymentFlowsPaymentDetailsResourceCarRentalDriver = z.object({
'driver_identification_number': z.string().optional(),
'driver_tax_number': z.string().optional(),
'name': z.string().optional()
});

export type PaymentFlowsPaymentDetailsResourceCarRentalDriverModel = z.infer<typeof PaymentFlowsPaymentDetailsResourceCarRentalDriver>;

export const PaymentFlowsPaymentDetailsResourceCarRental = z.object({
'affiliate': PaymentFlowsPaymentDetailsResourceAffiliate.optional(),
'booking_number': z.string(),
'car_class_code': z.string().optional(),
'car_make': z.string().optional(),
'car_model': z.string().optional(),
'company': z.string().optional(),
'customer_service_phone_number': z.string().optional(),
'days_rented': z.number().int(),
'delivery': PaymentFlowsPaymentDetailsResourceDelivery.optional(),
'distance': PaymentFlowsPaymentDetailsResourceCarRentalDistance.optional(),
'drivers': z.array(PaymentFlowsPaymentDetailsResourceCarRentalDriver).optional(),
'extra_charges': z.array(z.enum(['extra_mileage', 'gas', 'late_return', 'one_way_service', 'parking_violation'])).optional(),
'no_show': z.boolean().optional(),
'pickup_address': Address.optional(),
'pickup_at': z.number().int(),
'pickup_location_name': z.string().optional(),
'rate_amount': z.number().int().optional(),
'rate_interval': z.enum(['day', 'month', 'week']).optional(),
'renter_name': z.string().optional(),
'return_address': Address.optional(),
'return_at': z.number().int(),
'return_location_name': z.string().optional(),
'tax_exempt': z.boolean().optional(),
'vehicle_identification_number': z.string().optional()
});

export type PaymentFlowsPaymentDetailsResourceCarRentalModel = z.infer<typeof PaymentFlowsPaymentDetailsResourceCarRental>;

export const PaymentFlowsPaymentDetailsResourceEvent = z.object({
'access_controlled_venue': z.boolean().optional(),
'address': Address.optional(),
'affiliate': PaymentFlowsPaymentDetailsResourceAffiliate.optional(),
'company': z.string().optional(),
'delivery': PaymentFlowsPaymentDetailsResourceDelivery.optional(),
...
export type PaymentFlowsPaymentDetailsResourceEventModel = z.infer<typeof PaymentFlowsPaymentDetailsResourceEvent>;

export const PaymentFlowsPaymentDetailsResourceBillingInterval = z.object({
'count': z.number().int().optional(),
'interval': z.enum(['day', 'month', 'week', 'year']).optional()
});

export type PaymentFlowsPaymentDetailsResourceBillingIntervalModel = z.infer<typeof PaymentFlowsPaymentDetailsResourceBillingInterval>;

export const PaymentFlowsPaymentDetailsResourceSubscription = z.object({
'affiliate': PaymentFlowsPaymentDetailsResourceAffiliate.optional(),
'auto_renewal': z.boolean().optional(),
'billing_interval': PaymentFlowsPaymentDetailsResourceBillingInterval.optional(),
'ends_at': z.number().int().optional(),
'name': z.string().optional(),
'starts_at': z.number().int().optional()
});

export type PaymentFlowsPaymentDetailsResourceSubscriptionModel = z.infer<typeof PaymentFlowsPaymentDetailsResourceSubscription>;

export const PaymentFlowsPaymentDetails = z.object({
'car_rental': PaymentFlowsPaymentDetailsResourceCarRental.optional(),
'customer_reference': z.string(),
'event_details': PaymentFlowsPaymentDetailsResourceEvent.optional(),
'order_reference': z.string(),
'subscription': PaymentFlowsPaymentDetailsResourceSubscription.optional()
});
...
export const PaymentFlowsPrivatePaymentMethodsCardOptionsStatementDetailsResourceAddress = z.object({
...
export type PaymentFlowsPrivatePaymentMethodsCardOptionsStatementDetailsResourceAddressModel = z.infer<typeof PaymentFlowsPrivatePaymentMethodsCardOptionsStatementDetailsResourceAddress>;

export const PaymentFlowsPrivatePaymentMethodsCardOptionsStatementDetails = z.object({
'address': PaymentFlowsPrivatePaymentMethodsCardOptionsStatementDetailsResourceAddress.optional(),
'phone': z.string().optional()
});

export type PaymentFlowsPrivatePaymentMethodsCardOptionsStatementDetailsModel = z.infer<typeof PaymentFlowsPrivatePaymentMethodsCardOptionsStatementDetails>;
...
'request_decremental_authorization': z.enum(['if_available', 'never']).optional(),
...
'request_partial_authorization': z.enum(['if_available', 'never']).optional(),
...
'statement_details': PaymentFlowsPrivatePaymentMethodsCardOptionsStatementDetails.optional()
});
...
export const PaymentMethodOptionsGopay = z.object({
'setup_future_usage': z.enum(['none', 'off_session']).optional()
});

export type PaymentMethodOptionsGopayModel = z.infer<typeof PaymentMethodOptionsGopay>;
...
export const PaymentMethodOptionsIdBankTransfer = z.object({
'expires_after': z.number().int().optional(),
'expires_at': z.number().int(),
'setup_future_usage': z.enum(['none']).optional()
});

export type PaymentMethodOptionsIdBankTransferModel = z.infer<typeof PaymentMethodOptionsIdBankTransfer>;
...
export const PaymentFlowsPrivatePaymentMethodsPaypalLineItemResourceTax = z.object({
'amount': z.number().int(),
'behavior': z.enum(['exclusive', 'inclusive'])
});

export type PaymentFlowsPrivatePaymentMethodsPaypalLineItemResourceTaxModel = z.infer<typeof PaymentFlowsPrivatePaymentMethodsPaypalLineItemResourceTax>;

export const LineItemPaypal = z.object({
'category': z.enum(['digital_goods', 'donation', 'physical_goods']).optional(),
'description': z.string().optional(),
'name': z.string(),
'quantity': z.number().int(),
...
'sold_by': z.string().optional(),
'tax': PaymentFlowsPrivatePaymentMethodsPaypalLineItemResourceTax.optional(),
'unit_amount': z.number().int()
});

export type LineItemPaypalModel = z.infer<typeof LineItemPaypal>;

export const PaymentMethodOptionsPaypal = z.object({
'capture_method': z.enum(['manual']).optional(),
'line_items': z.array(LineItemPaypal).optional(),
'preferred_locale': z.string(),
'reference': z.string(),
'reference_id': z.string().optional(),
'setup_future_usage': z.enum(['none', 'off_session']).optional(),
...
export const PaymentMethodOptionsPaypay = z.object({

});

export type PaymentMethodOptionsPaypayModel = z.infer<typeof PaymentMethodOptionsPaypay>;

export const PaymentIntentPaymentMethodOptionsMandateOptionsPayto = z.object({
'amount': z.number().int(),
'amount_type': z.enum(['fixed', 'maximum']),
'end_date': z.string(),
'payment_schedule': z.enum(['adhoc', 'annual', 'daily', 'fortnightly', 'monthly', 'quarterly', 'semi_annual', 'weekly']),
...
export type PaymentIntentPaymentMethodOptionsMandateOptionsPaytoModel = z.infer<typeof PaymentIntentPaymentMethodOptionsMandateOptionsPayto>;

export const PaymentIntentPaymentMethodOptionsPayto = z.object({
'mandate_options': PaymentIntentPaymentMethodOptionsMandateOptionsPayto.optional(),
'setup_future_usage': z.enum(['none', 'off_session']).optional()
});

export type PaymentIntentPaymentMethodOptionsPaytoModel = z.infer<typeof PaymentIntentPaymentMethodOptionsPayto>;

export const PaymentMethodOptionsMandateOptionsPix = z.object({
'amount': z.number().int().optional(),
'amount_includes_iof': z.enum(['always', 'never']).optional(),
'amount_type': z.enum(['fixed', 'maximum']).optional(),
'currency': z.string().optional(),
...
export type PaymentMethodOptionsMandateOptionsPixModel = z.infer<typeof PaymentMethodOptionsMandateOptionsPix>;

export const PaymentMethodOptionsPix = z.object({
'amount_includes_iof': z.enum(['always', 'never']).optional(),
'expires_after_seconds': z.number().int(),
'expires_at': z.number().int(),
'mandate_options': PaymentMethodOptionsMandateOptionsPix.optional(),
'setup_future_usage': z.enum(['none', 'off_session']).optional()
});
...
export const PaymentMethodOptionsQris = z.object({
'setup_future_usage': z.enum(['none']).optional()
});

export type PaymentMethodOptionsQrisModel = z.infer<typeof PaymentMethodOptionsQris>;

export const PaymentIntentPaymentMethodOptionsRechnung = z.object({

});

export type PaymentIntentPaymentMethodOptionsRechnungModel = z.infer<typeof PaymentIntentPaymentMethodOptionsRechnung>;
...
export const PaymentMethodOptionsShopeepay = z.object({
'setup_future_usage': z.enum(['none']).optional()
});

export type PaymentMethodOptionsShopeepayModel = z.infer<typeof PaymentMethodOptionsShopeepay>;
...
export const PaymentIntentPaymentMethodOptionsStripeBalance = z.object({
'setup_future_usage': z.enum(['none', 'off_session']).optional()
});

export type PaymentIntentPaymentMethodOptionsStripeBalanceModel = z.infer<typeof PaymentIntentPaymentMethodOptionsStripeBalance>;
...
export const PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsManualEntry = z.object({
'mode': z.enum(['automatic', 'custom']).optional()
});

export type PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsManualEntryModel = z.infer<typeof PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsManualEntry>;
...
'manual_entry': PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsManualEntry.optional(),
'permissions': z.array(z.enum(['balances', 'ownership', 'payment_method', 'transactions'])).optional(),
'prefetch': z.array(z.enum(['balances', 'inferred_balances', 'ownership', 'transactions'])),
...
'gopay': PaymentMethodOptionsGopay.optional(),
'grabpay': PaymentMethodOptionsGrabpay.optional(),
'id_bank_transfer': PaymentMethodOptionsIdBankTransfer.optional(),
...
'paypay': PaymentMethodOptionsPaypay.optional(),
'payto': PaymentIntentPaymentMethodOptionsPayto.optional(),
'pix': PaymentMethodOptionsPix.optional(),
'promptpay': PaymentMethodOptionsPromptpay.optional(),
'qris': PaymentMethodOptionsQris.optional(),
'rechnung': PaymentIntentPaymentMethodOptionsRechnung.optional(),
...
'shopeepay': PaymentMethodOptionsShopeepay.optional(),
'sofort': PaymentMethodOptionsSofort.optional(),
'stripe_balance': PaymentIntentPaymentMethodOptionsStripeBalance.optional(),
...
'receipt_email': z.string(),
'review': z.union([z.string(), z.lazy(() => Review)]),
'secret_key_confirmation': z.enum(['optional', 'required']).optional(),
...
export const SetupIntentNextActionPixDisplayQrCode = z.object({
'data': z.string().optional(),
'expires_at': z.number().int().optional(),
'hosted_instructions_url': z.string().optional(),
'image_url_png': z.string().optional(),
...
export type SetupIntentNextActionPixDisplayQrCodeModel = z.infer<typeof SetupIntentNextActionPixDisplayQrCode>;
...
'cashapp_handle_redirect_or_display_qr_code': PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode.optional(),
'pix_display_qr_code': SetupIntentNextActionPixDisplayQrCode.optional(),
...
export const SetupIntentPaymentMethodOptionsMandateOptionsPayto = z.object({
'amount': z.number().int(),
'amount_type': z.enum(['fixed', 'maximum']),
'end_date': z.string(),
'payment_schedule': z.enum(['adhoc', 'annual', 'daily', 'fortnightly', 'monthly', 'quarterly', 'semi_annual', 'weekly']),
...
export type SetupIntentPaymentMethodOptionsMandateOptionsPaytoModel = z.infer<typeof SetupIntentPaymentMethodOptionsMandateOptionsPayto>;

export const SetupIntentPaymentMethodOptionsPayto = z.object({
'mandate_options': SetupIntentPaymentMethodOptionsMandateOptionsPayto.optional()
});

export type SetupIntentPaymentMethodOptionsPaytoModel = z.infer<typeof SetupIntentPaymentMethodOptionsPayto>;

export const SetupIntentPaymentMethodOptionsPix = z.object({
'mandate_options': PaymentMethodOptionsMandateOptionsPix.optional()
});

export type SetupIntentPaymentMethodOptionsPixModel = z.infer<typeof SetupIntentPaymentMethodOptionsPix>;
...
'payto': SetupIntentPaymentMethodOptionsPayto.optional(),
'pix': SetupIntentPaymentMethodOptionsPix.optional(),
...
export const PaymentMethodGopay = z.object({

});

export type PaymentMethodGopayModel = z.infer<typeof PaymentMethodGopay>;
...
export const PaymentMethodIdBankTransfer = z.object({
'bank': z.enum(['bca', 'bni', 'bri', 'cimb', 'permata']),
'bank_code': z.string(),
'bank_name': z.string(),
'display_name': z.string()
...
export type PaymentMethodIdBankTransferModel = z.infer<typeof PaymentMethodIdBankTransfer>;
...
export const PaymentMethodPaypay = z.object({

});

export type PaymentMethodPaypayModel = z.infer<typeof PaymentMethodPaypay>;

export const PaymentMethodPayto = z.object({
'bsb_number': z.string(),
'last4': z.string(),
'pay_id': z.string()
});

export type PaymentMethodPaytoModel = z.infer<typeof PaymentMethodPayto>;
...
export const PaymentMethodQris = z.object({

});

export type PaymentMethodQrisModel = z.infer<typeof PaymentMethodQris>;

export const PaymentFlowsPrivatePaymentMethodsRechnungDob = z.object({
'day': z.number().int(),
'month': z.number().int(),
'year': z.number().int()
});

export type PaymentFlowsPrivatePaymentMethodsRechnungDobModel = z.infer<typeof PaymentFlowsPrivatePaymentMethodsRechnungDob>;

export const PaymentMethodRechnung = z.object({
'dob': PaymentFlowsPrivatePaymentMethodsRechnungDob.optional()
});

export type PaymentMethodRechnungModel = z.infer<typeof PaymentMethodRechnung>;
...
export const PaymentMethodShopeepay = z.object({

});

export type PaymentMethodShopeepayModel = z.infer<typeof PaymentMethodShopeepay>;
...
export const PaymentMethodStripeBalance = z.object({
'account': z.string().optional(),
'source_type': z.enum(['bank_account', 'card', 'fpx'])
});

export type PaymentMethodStripeBalanceModel = z.infer<typeof PaymentMethodStripeBalance>;
...
'gopay': PaymentMethodGopay.optional(),
'grabpay': PaymentMethodGrabpay.optional(),
'id': z.string(),
'id_bank_transfer': PaymentMethodIdBankTransfer.optional(),
...
'latest_active_mandate': z.union([z.lazy(() => Mandate)]).optional(),
...
'paypay': PaymentMethodPaypay.optional(),
'payto': PaymentMethodPayto.optional(),
'pix': PaymentMethodPix.optional(),
'promptpay': PaymentMethodPromptpay.optional(),
'qris': PaymentMethodQris.optional(),
'radar_options': RadarRadarOptions.optional(),
'rechnung': PaymentMethodRechnung.optional(),
...
'shopeepay': PaymentMethodShopeepay.optional(),
'sofort': PaymentMethodSofort.optional(),
'stripe_balance': PaymentMethodStripeBalance.optional(),
...
export const MigrateTo = z.object({
'behavior': z.enum(['at_cycle_end']),
'effective_after': z.number().int(),
'price': z.string()
});

export type MigrateToModel = z.infer<typeof MigrateTo>;
...
'lookup_key': z.string(),
'metadata': z.record(z.string(), z.string()),
'migrate_to': z.union([MigrateTo]).optional(),
'nickname': z.string(),
'object': z.enum(['price']),
...
export const SubscriptionsResourceBillingSchedulesAppliesTo: z.ZodType<SubscriptionsResourceBillingSchedulesAppliesToModel> = z.object({
'price': z.union([z.string(), z.lazy(() => Price)]),
'type': z.enum(['price'])
});

export const SubscriptionsResourceBillingSchedulesBillUntilDuration = z.object({
'interval': z.enum(['day', 'month', 'week', 'year']),
'interval_count': z.number().int()
});

export type SubscriptionsResourceBillingSchedulesBillUntilDurationModel = z.infer<typeof SubscriptionsResourceBillingSchedulesBillUntilDuration>;

export const SubscriptionsResourceBillingSchedulesBillUntil = z.object({
'computed_timestamp': z.number().int(),
'duration': z.union([SubscriptionsResourceBillingSchedulesBillUntilDuration]),
'timestamp': z.number().int(),
'type': z.enum(['duration', 'timestamp'])
});

export type SubscriptionsResourceBillingSchedulesBillUntilModel = z.infer<typeof SubscriptionsResourceBillingSchedulesBillUntil>;

export const SubscriptionsResourceBillingSchedules: z.ZodType<SubscriptionsResourceBillingSchedulesModel> = z.object({
'applies_to': z.array(z.lazy(() => SubscriptionsResourceBillingSchedulesAppliesTo)),
...
export const SubscriptionsTrialsResourceTrial = z.object({
'converts_to': z.array(z.string()).optional(),
'type': z.enum(['free', 'paid'])
});

export type SubscriptionsTrialsResourceTrialModel = z.infer<typeof SubscriptionsTrialsResourceTrial>;

export const SubscriptionItem = z.object({
'billed_until': z.number().int().optional(),
...
'trial': z.union([SubscriptionsTrialsResourceTrial]).optional()
});

export type SubscriptionItemModel = z.infer<typeof SubscriptionItem>;

export const SubscriptionsResourcePriceMigrationErrorFailedTransition = z.object({
'source_price': z.string(),
'target_price': z.string()
});

export type SubscriptionsResourcePriceMigrationErrorFailedTransitionModel = z.infer<typeof SubscriptionsResourcePriceMigrationErrorFailedTransition>;

export const SubscriptionsResourcePriceMigrationError = z.object({
'errored_at': z.number().int(),
'failed_transitions': z.array(SubscriptionsResourcePriceMigrationErrorFailedTransition),
'type': z.enum(['price_uniqueness_violation'])
});

export type SubscriptionsResourcePriceMigrationErrorModel = z.infer<typeof SubscriptionsResourcePriceMigrationError>;

export const PaymentPlanAmount = z.object({
'amount': z.number().int(),
...
'status': z.enum(['open', 'paid', 'past_due'])
});

export type PaymentPlanAmountModel = z.infer<typeof PaymentPlanAmount>;
...
'metadata': z.record(z.string(), z.string()),
'name': z.string(),
'object': z.enum(['margin']),
'percent_off': z.number(),
'updated': z.number().int()
});

export type MarginModel = z.infer<typeof Margin>;
...
export const MarginsResourceMarginAmount = z.object({
'amount': z.number().int(),
'margin': z.union([z.string(), Margin])
});

export type MarginsResourceMarginAmountModel = z.infer<typeof MarginsResourceMarginAmount>;
...
'margin': z.union([z.string(), Margin]).optional(),
'type': z.enum(['credit_balance_transaction', 'discount', 'margin'])
});
...
export const TaxProductIntegrationResourceTaxCalculationReference = z.object({
'calculation_id': z.string(),
'calculation_item_id': z.string()
});

export type TaxProductIntegrationResourceTaxCalculationReferenceModel = z.infer<typeof TaxProductIntegrationResourceTaxCalculationReference>;
...
'invoice': z.string(),
'livemode': z.boolean(),
'margin_amounts': z.array(MarginsResourceMarginAmount).optional(),
'margins': z.array(z.union([z.string(), Margin])).optional(),
'metadata': z.record(z.string(), z.string()),
...
'tax_calculation_reference': z.union([TaxProductIntegrationResourceTaxCalculationReference]).optional(),
'taxes': z.array(BillingBillResourceInvoicingTaxesTax)
});

export const BillingBillResourceInvoicingParentsInvoiceBillingCadenceParent = z.object({
'billing_cadence': z.string()
});

export type BillingBillResourceInvoicingParentsInvoiceBillingCadenceParentModel = z.infer<typeof BillingBillResourceInvoicingParentsInvoiceBillingCadenceParent>;
...
export const BillingBillResourceInvoicingCommonInvoicePauseCollection = z.object({
'behavior': z.enum(['keep_as_draft', 'mark_uncollectible', 'void']),
'resumes_at': z.number().int()
});

export type BillingBillResourceInvoicingCommonInvoicePauseCollectionModel = z.infer<typeof BillingBillResourceInvoicingCommonInvoicePauseCollection>;
...
'metadata': z.record(z.string(), z.string()),
'pause_collection': z.union([BillingBillResourceInvoicingCommonInvoicePauseCollection]).optional(),
'subscription': z.union([z.string(), z.lazy(() => Subscription)]),
...
'billing_cadence_details': z.union([BillingBillResourceInvoicingParentsInvoiceBillingCadenceParent]).optional(),
...
'type': z.enum(['billing_cadence_details', 'quote_details', 'subscription_details'])
});
...
export const InvoicePaymentMethodOptionsIdBankTransfer = z.object({

});

export type InvoicePaymentMethodOptionsIdBankTransferModel = z.infer<typeof InvoicePaymentMethodOptionsIdBankTransfer>;
...
export const InvoicePaymentMethodOptionsPix = z.object({
'amount_includes_iof': z.enum(['always', 'never'])
});

export type InvoicePaymentMethodOptionsPixModel = z.infer<typeof InvoicePaymentMethodOptionsPix>;
...
export const InvoicePaymentMethodOptionsMandateOptionsUpi = z.object({
'amount': z.number().int(),
'amount_type': z.enum(['fixed', 'maximum']),
'description': z.string(),
'end_date': z.number().int()
...
export type InvoicePaymentMethodOptionsMandateOptionsUpiModel = z.infer<typeof InvoicePaymentMethodOptionsMandateOptionsUpi>;

export const InvoicePaymentMethodOptionsUpi = z.object({
'mandate_options': InvoicePaymentMethodOptionsMandateOptionsUpi.optional()
});

export type InvoicePaymentMethodOptionsUpiModel = z.infer<typeof InvoicePaymentMethodOptionsUpi>;
...
'id_bank_transfer': z.union([InvoicePaymentMethodOptionsIdBankTransfer]).optional(),
'konbini': z.union([InvoicePaymentMethodOptionsKonbini]),
'pix': z.union([InvoicePaymentMethodOptionsPix]).optional(),
'sepa_debit': z.union([InvoicePaymentMethodOptionsSepaDebit]),
'upi': z.union([InvoicePaymentMethodOptionsUpi]).optional(),
...
'amounts_due': z.array(PaymentPlanAmount).optional(),
...
'default_margins': z.array(z.union([z.string(), Margin])).optional(),
'default_payment_method': z.union([z.string(), z.lazy(() => PaymentMethod)]),
...
'total_margin_amounts': z.array(MarginsResourceMarginAmount).optional(),
...
export const SubscriptionPaymentMethodOptionsMandateOptionsPix = z.object({
'amount': z.number().int(),
'amount_includes_iof': z.enum(['always', 'never']),
'end_date': z.string(),
'payment_schedule': z.enum(['halfyearly', 'monthly', 'quarterly', 'weekly', 'yearly'])
});

export type SubscriptionPaymentMethodOptionsMandateOptionsPixModel = z.infer<typeof SubscriptionPaymentMethodOptionsMandateOptionsPix>;

export const SubscriptionPaymentMethodOptionsPix = z.object({
'mandate_options': SubscriptionPaymentMethodOptionsMandateOptionsPix.optional()
});

export type SubscriptionPaymentMethodOptionsPixModel = z.infer<typeof SubscriptionPaymentMethodOptionsPix>;
...
'id_bank_transfer': z.union([InvoicePaymentMethodOptionsIdBankTransfer]).optional(),
'konbini': z.union([InvoicePaymentMethodOptionsKonbini]),
'pix': z.union([SubscriptionPaymentMethodOptionsPix]).optional(),
'sepa_debit': z.union([InvoicePaymentMethodOptionsSepaDebit]),
'upi': z.union([InvoicePaymentMethodOptionsUpi]).optional(),
'us_bank_account': z.union([InvoicePaymentMethodOptionsUsBankAccount])
});
...
'expires_at': z.number().int(),
'prebilling_iterations': z.number().int().optional(),
'subscription_items': z.array(SubscriptionItem),
...
export const SubscriptionPrebillingData = z.object({
'invoice': z.union([z.string(), z.lazy(() => Invoice)]),
'period_end': z.number().int(),
'period_start': z.number().int(),
'update_behavior': z.enum(['prebill', 'reset']).optional()
});

export type SubscriptionPrebillingDataModel = z.infer<typeof SubscriptionPrebillingData>;
...
export const DiscountEnd = z.object({
'timestamp': z.number().int(),
'type': z.enum(['timestamp'])
});

export type DiscountEndModel = z.infer<typeof DiscountEnd>;

export const DiscountsResourceStackableDiscount = z.object({
'coupon': z.union([z.string(), Coupon]),
'discount': z.union([z.string(), z.lazy(() => Discount)]),
'discount_end': z.union([DiscountEnd]).optional(),
'promotion_code': z.union([z.string(), z.lazy(() => PromotionCode)])
});
...
'discounts': z.array(DiscountsResourceStackableDiscount),
'metadata': z.record(z.string(), z.string()),
'plan': z.union([z.string(), Plan, DeletedPlan]),
'price': z.union([z.string(), z.lazy(() => Price), DeletedPrice]),
'quantity': z.number().int().optional(),
'tax_rates': z.array(TaxRate).optional(),
'trial': z.union([SubscriptionsTrialsResourceTrial]).optional()
...
export const SubscriptionSchedulesResourcePauseCollection = z.object({
'behavior': z.enum(['keep_as_draft', 'mark_uncollectible', 'void'])
});

export type SubscriptionSchedulesResourcePauseCollectionModel = z.infer<typeof SubscriptionSchedulesResourcePauseCollection>;

export const SubscriptionSchedulesResourceEndBehavior = z.object({
'prorate_up_front': z.enum(['defer', 'include'])
});

export type SubscriptionSchedulesResourceEndBehaviorModel = z.infer<typeof SubscriptionSchedulesResourceEndBehavior>;

export const SubscriptionSchedulesResourceTrialSettings = z.object({
'end_behavior': z.union([SubscriptionSchedulesResourceEndBehavior])
});

export type SubscriptionSchedulesResourceTrialSettingsModel = z.infer<typeof SubscriptionSchedulesResourceTrialSettings>;
...
'metadata': z.record(z.string(), z.string()),
'on_behalf_of': z.union([z.string(), z.lazy(() => Account)]),
'pause_collection': z.union([SubscriptionSchedulesResourcePauseCollection]).optional(),
'proration_behavior': z.enum(['always_invoice', 'create_prorations', 'none']),
'start_date': z.number().int(),
'transfer_data': z.union([z.lazy(() => SubscriptionTransferData)]),
'trial_continuation': z.enum(['continue', 'none']).optional(),
'trial_end': z.number().int(),
'trial_settings': z.union([SubscriptionSchedulesResourceTrialSettings]).optional()
});

export const SubscriptionSchedule: z.ZodType<SubscriptionScheduleModel> = z.object({
'application': z.union([z.string(), Application, DeletedApplication]),
'billing_behavior': z.enum(['prorate_on_next_phase', 'prorate_up_front']).optional(),
...
'id': z.string(),
'last_price_migration_error': z.union([SubscriptionsResourcePriceMigrationError]).optional(),
'livemode': z.boolean(),
'metadata': z.record(z.string(), z.string()),
'object': z.enum(['subscription_schedule']),
'phases': z.array(z.lazy(() => SubscriptionSchedulePhaseConfiguration)),
'prebilling': z.union([SubscriptionPrebillingData]).optional(),
...
'billing_cadence': z.string().optional(),
'billing_cycle_anchor': z.number().int(),
'billing_cycle_anchor_config': z.union([SubscriptionsResourceBillingCycleAnchorConfig]),
'billing_mode': SubscriptionsResourceBillingMode,
'billing_schedules': z.array(z.lazy(() => SubscriptionsResourceBillingSchedules)).optional(),
'billing_thresholds': z.union([SubscriptionBillingThresholds]),
...
export const ConnectRiskAccountRiskControl = z.object({
'pause_requested': z.boolean()
});

export type ConnectRiskAccountRiskControlModel = z.infer<typeof ConnectRiskAccountRiskControl>;

export const ConnectRiskAccountRiskControls = z.object({
'charges': ConnectRiskAccountRiskControl,
'payouts': ConnectRiskAccountRiskControl,
'rejected_reason': z.enum(['credit', 'fraud', 'fraud_no_intent_to_fulfill', 'fraud_other', 'fraud_payment_method_casher', 'fraud_payment_method_tester', 'other', 'terms_of_service']).optional()
});

export type ConnectRiskAccountRiskControlsModel = z.infer<typeof ConnectRiskAccountRiskControls>;
...
export const AccountBankBcaOnboardingSettings = z.object({
'account_holder_name': z.string().optional(),
'business_account_number': z.string().optional()
});

export type AccountBankBcaOnboardingSettingsModel = z.infer<typeof AccountBankBcaOnboardingSettings>;
...
export const AccountCapitalSettings = z.object({
'payout_destination': z.record(z.string(), z.string()).optional(),
'payout_destination_selector': z.record(z.string(), z.array(z.string())).optional()
});

export type AccountCapitalSettingsModel = z.infer<typeof AccountCapitalSettings>;
...
export const AccountPaypayPaymentsSettings = z.object({
'goods_type': z.enum(['digital_content', 'other']).optional()
});

export type AccountPaypayPaymentsSettingsModel = z.infer<typeof AccountPaypayPaymentsSettings>;
...
export const TaxReportingAccountSettingsResourceTaxFormSettings = z.object({
'consented_to_paperless_delivery': z.boolean()
});

export type TaxReportingAccountSettingsResourceTaxFormSettingsModel = z.infer<typeof TaxReportingAccountSettingsResourceTaxFormSettings>;
...
'bank_bca_onboarding': AccountBankBcaOnboardingSettings.optional(),
'branding': AccountBrandingSettings,
'capital': AccountCapitalSettings.optional(),
...
'paypay_payments': AccountPaypayPaymentsSettings.optional(),
'sepa_debit_payments': AccountSepaDebitPaymentsSettings.optional(),
'tax_forms': TaxReportingAccountSettingsResourceTaxFormSettings.optional(),
...
'risk_controls': ConnectRiskAccountRiskControls.optional(),
...
export const IssuingComplianceNoticeEmail = z.object({
'plain_text': z.string(),
'recipient': z.string(),
'subject': z.string()
});

export type IssuingComplianceNoticeEmailModel = z.infer<typeof IssuingComplianceNoticeEmail>;

export const IssuingComplianceNoticeLinkedObjects = z.object({
'capability': z.string(),
'issuing_credit_underwriting_record': z.string().optional(),
'issuing_dispute': z.string()
});

export type IssuingComplianceNoticeLinkedObjectsModel = z.infer<typeof IssuingComplianceNoticeLinkedObjects>;

export const AccountNotice = z.object({
'created': z.number().int(),
'deadline': z.number().int(),
'email': z.union([IssuingComplianceNoticeEmail]),
'id': z.string(),
'linked_objects': z.union([IssuingComplianceNoticeLinkedObjects]),
'livemode': z.boolean(),
'metadata': z.record(z.string(), z.string()),
'object': z.enum(['account_notice']),
'reason': z.enum(['issuing.account_closed_for_inactivity', 'issuing.account_closed_for_not_providing_business_model_clarification', 'issuing.account_closed_for_not_providing_url_clarification', 'issuing.account_closed_for_not_providing_use_case_clarification', 'issuing.account_closed_for_terms_of_service_violation', 'issuing.application_rejected_for_failure_to_verify', 'issuing.credit_application_rejected', 'issuing.credit_increase_application_rejected', 'issuing.credit_limit_decreased', 'issuing.credit_line_closed', 'issuing.dispute_lost', 'issuing.dispute_submitted', 'issuing.dispute_won']),
'sent_at': z.number().int()
});

export type AccountNoticeModel = z.infer<typeof AccountNotice>;

export const AccountNoticeCreated = z.object({
'object': AccountNotice
});

export type AccountNoticeCreatedModel = z.infer<typeof AccountNoticeCreated>;

export const AccountNoticeUpdated = z.object({
'object': AccountNotice
});

export type AccountNoticeUpdatedModel = z.infer<typeof AccountNoticeUpdated>;
...
export const ConnectEmbeddedBaseConfig = z.object({
'enabled': z.boolean(),
'features': ConnectEmbeddedBaseFeatures
});

export type ConnectEmbeddedBaseConfigModel = z.infer<typeof ConnectEmbeddedBaseConfig>;
...
'capital_financing': z.union([ConnectEmbeddedBaseConfig]).optional(),
'capital_financing_application': z.union([ConnectEmbeddedBaseConfig]).optional(),
'capital_financing_promotion': z.union([ConnectEmbeddedBaseConfig]).optional(),
...
export const BankConnectionsResourceInferredBalancesRefresh = z.object({
'last_attempted_at': z.number().int(),
'next_refresh_available_at': z.number().int(),
'status': z.enum(['failed', 'pending', 'succeeded'])
});

export type BankConnectionsResourceInferredBalancesRefreshModel = z.infer<typeof BankConnectionsResourceInferredBalancesRefresh>;

export const BankConnectionsResourceInstitutionSupportedFeature = z.object({
'supported': z.boolean()
});

export type BankConnectionsResourceInstitutionSupportedFeatureModel = z.infer<typeof BankConnectionsResourceInstitutionSupportedFeature>;

export const BankConnectionsResourceInstitutionFeatureSupport = z.object({
'balances': BankConnectionsResourceInstitutionSupportedFeature,
'ownership': BankConnectionsResourceInstitutionSupportedFeature,
'payment_method': BankConnectionsResourceInstitutionSupportedFeature,
'transactions': BankConnectionsResourceInstitutionSupportedFeature
});

export type BankConnectionsResourceInstitutionFeatureSupportModel = z.infer<typeof BankConnectionsResourceInstitutionFeatureSupport>;
...
export const BankConnectionsResourceLinkAccountSessionLimits = z.object({
'accounts': z.number().int()
});

export type BankConnectionsResourceLinkAccountSessionLimitsModel = z.infer<typeof BankConnectionsResourceLinkAccountSessionLimits>;

export const BankConnectionsResourceLinkAccountSessionManualEntry = z.object({

});

export type BankConnectionsResourceLinkAccountSessionManualEntryModel = z.infer<typeof BankConnectionsResourceLinkAccountSessionManualEntry>;

export const BankConnectionsResourceLinkAccountSessionStatusDetailsResourceCancelledStatusDetails = z.object({
'reason': z.enum(['custom_manual_entry', 'other'])
});

export type BankConnectionsResourceLinkAccountSessionStatusDetailsResourceCancelledStatusDetailsModel = z.infer<typeof BankConnectionsResourceLinkAccountSessionStatusDetailsResourceCancelledStatusDetails>;

export const BankConnectionsResourceLinkAccountSessionStatusDetails = z.object({
'cancelled': BankConnectionsResourceLinkAccountSessionStatusDetailsResourceCancelledStatusDetails.optional()
});

export type BankConnectionsResourceLinkAccountSessionStatusDetailsModel = z.infer<typeof BankConnectionsResourceLinkAccountSessionStatusDetails>;
...
export const BillingAnalyticsMeterUsageRow = z.object({
'dimensions': z.record(z.string(), z.string()),
'ends_at': z.number().int(),
'id': z.string(),
'meter': z.string(),
'object': z.enum(['billing.analytics.meter_usage_row']),
'starts_at': z.number().int(),
'value': z.number()
});

export type BillingAnalyticsMeterUsageRowModel = z.infer<typeof BillingAnalyticsMeterUsageRow>;

export const BillingOverviewResourcesMeterUsageRows = z.object({
'data': z.array(BillingAnalyticsMeterUsageRow),
'has_more': z.boolean(),
'total': z.number().int(),
'url': z.string()
});

export type BillingOverviewResourcesMeterUsageRowsModel = z.infer<typeof BillingOverviewResourcesMeterUsageRows>;

export const BillingAnalyticsMeterUsage = z.object({
'livemode': z.boolean(),
'object': z.enum(['billing.analytics.meter_usage']),
'refreshed_at': z.number().int(),
'rows': BillingOverviewResourcesMeterUsageRows
});

export type BillingAnalyticsMeterUsageModel = z.infer<typeof BillingAnalyticsMeterUsage>;
...
export const CapitalConnectConnectFinancingAcceptedTerms = z.object({
'advance_amount': z.number().int(),
'currency': z.string(),
'fee_amount': z.number().int(),
'previous_financing_fee_discount_amount': z.number().int(),
'withhold_rate': z.number()
});

export type CapitalConnectConnectFinancingAcceptedTermsModel = z.infer<typeof CapitalConnectConnectFinancingAcceptedTerms>;

export const CapitalConnectConnectFinancingOfferedTerms = z.object({
'advance_amount': z.number().int(),
'campaign_type': z.enum(['newly_eligible_user', 'previously_eligible_user', 'repeat_user']),
'currency': z.string(),
'fee_amount': z.number().int(),
'previous_financing_fee_discount_rate': z.number(),
'withhold_rate': z.number()
});

export type CapitalConnectConnectFinancingOfferedTermsModel = z.infer<typeof CapitalConnectConnectFinancingOfferedTerms>;

export const CapitalFinancingOffer = z.object({
'accepted_terms': CapitalConnectConnectFinancingAcceptedTerms.optional(),
'account': z.string(),
'charged_off_at': z.number().int().optional(),
'created': z.number().int(),
'expires_after': z.number(),
'financing_type': z.enum(['cash_advance', 'flex_loan']).optional(),
'id': z.string(),
'livemode': z.boolean(),
'metadata': z.record(z.string(), z.string()).optional(),
'object': z.enum(['capital.financing_offer']),
'offered_terms': CapitalConnectConnectFinancingOfferedTerms.optional(),
'product_type': z.enum(['refill', 'standard']).optional(),
'replacement': z.string().optional(),
'replacement_for': z.string().optional(),
'status': z.enum(['accepted', 'canceled', 'completed', 'delivered', 'expired', 'fully_repaid', 'paid_out', 'rejected', 'replaced', 'undelivered']),
'type': z.enum(['cash_advance', 'fixed_term_loan', 'flex_loan']).optional()
});

export type CapitalFinancingOfferModel = z.infer<typeof CapitalFinancingOffer>;

export const CapitalFinancingOfferAccepted = z.object({
'object': CapitalFinancingOffer
});

export type CapitalFinancingOfferAcceptedModel = z.infer<typeof CapitalFinancingOfferAccepted>;

export const CapitalFinancingOfferCanceled = z.object({
'object': CapitalFinancingOffer
});

export type CapitalFinancingOfferCanceledModel = z.infer<typeof CapitalFinancingOfferCanceled>;

export const CapitalFinancingOfferCreated = z.object({
'object': CapitalFinancingOffer
});

export type CapitalFinancingOfferCreatedModel = z.infer<typeof CapitalFinancingOfferCreated>;

export const CapitalFinancingOfferExpired = z.object({
'object': CapitalFinancingOffer
});

export type CapitalFinancingOfferExpiredModel = z.infer<typeof CapitalFinancingOfferExpired>;

export const CapitalFinancingOfferFullyRepaid = z.object({
'object': CapitalFinancingOffer
});

export type CapitalFinancingOfferFullyRepaidModel = z.infer<typeof CapitalFinancingOfferFullyRepaid>;

export const CapitalFinancingOfferPaidOut = z.object({
'object': CapitalFinancingOffer
});

export type CapitalFinancingOfferPaidOutModel = z.infer<typeof CapitalFinancingOfferPaidOut>;

export const CapitalFinancingOfferRejected = z.object({
'object': CapitalFinancingOffer
});

export type CapitalFinancingOfferRejectedModel = z.infer<typeof CapitalFinancingOfferRejected>;

export const CapitalFinancingOfferReplacementCreated = z.object({
'object': CapitalFinancingOffer
});

export type CapitalFinancingOfferReplacementCreatedModel = z.infer<typeof CapitalFinancingOfferReplacementCreated>;

export const CapitalConnectFinancingSummaryCurrentRepaymentWindow = z.object({
'due_at': z.number(),
'paid_amount': z.number().int(),
'remaining_amount': z.number().int()
});

export type CapitalConnectFinancingSummaryCurrentRepaymentWindowModel = z.infer<typeof CapitalConnectFinancingSummaryCurrentRepaymentWindow>;

export const CapitalConnectFinancingSummaryDetails = z.object({
'advance_amount': z.number().int(),
'advance_paid_out_at': z.number(),
'currency': z.string(),
'current_repayment_interval': z.union([CapitalConnectFinancingSummaryCurrentRepaymentWindow]),
'fee_amount': z.number().int(),
'paid_amount': z.number().int(),
'remaining_amount': z.number().int(),
'repayments_begin_at': z.number(),
'withhold_rate': z.number()
});

export type CapitalConnectFinancingSummaryDetailsModel = z.infer<typeof CapitalConnectFinancingSummaryDetails>;

export const CapitalFinancingSummary = z.object({
'details': z.union([CapitalConnectFinancingSummaryDetails]),
'financing_offer': z.string(),
'object': z.enum(['capital.financing_summary']),
'status': z.enum(['accepted', 'delivered', 'none'])
});

export type CapitalFinancingSummaryModel = z.infer<typeof CapitalFinancingSummary>;

export const CapitalConnectFinancingTransactionDetailsTransaction = z.object({
'charge': z.string().optional(),
'treasury_transaction': z.string().optional()
});

export type CapitalConnectFinancingTransactionDetailsTransactionModel = z.infer<typeof CapitalConnectFinancingTransactionDetailsTransaction>;

export const CapitalConnectFinancingTransactionDetails = z.object({
'advance_amount': z.number().int(),
'currency': z.string(),
'fee_amount': z.number().int(),
'linked_payment': z.string().optional(),
'reason': z.enum(['automatic_withholding', 'automatic_withholding_refund', 'collection', 'collection_failure', 'financing_cancellation', 'refill', 'requested_by_user', 'user_initiated']).optional(),
'reversed_transaction': z.string().optional(),
'total_amount': z.number().int(),
'transaction': CapitalConnectFinancingTransactionDetailsTransaction.optional()
});

export type CapitalConnectFinancingTransactionDetailsModel = z.infer<typeof CapitalConnectFinancingTransactionDetails>;

export const CapitalFinancingTransaction = z.object({
'account': z.string(),
'created_at': z.number().int(),
'details': CapitalConnectFinancingTransactionDetails,
'financing_offer': z.string(),
'id': z.string(),
'legacy_balance_transaction_source': z.string().optional(),
'livemode': z.boolean(),
'object': z.enum(['capital.financing_transaction']),
'type': z.enum(['payment', 'payout', 'reversal']),
'user_facing_description': z.string()
});

export type CapitalFinancingTransactionModel = z.infer<typeof CapitalFinancingTransaction>;

export const CapitalFinancingTransactionCreated = z.object({
'object': CapitalFinancingTransaction
});

export type CapitalFinancingTransactionCreatedModel = z.infer<typeof CapitalFinancingTransactionCreated>;
...
export const LineItemsAdjustableQuantity = z.object({
'enabled': z.boolean(),
'maximum': z.number().int(),
'minimum': z.number().int()
});

export type LineItemsAdjustableQuantityModel = z.infer<typeof LineItemsAdjustableQuantity>;
...
export const LineItemsDisplay = z.object({
'description': z.string(),
'images': z.array(z.string()),
'name': z.string()
});

export type LineItemsDisplayModel = z.infer<typeof LineItemsDisplay>;

export const Item = z.object({
'adjustable_quantity': z.union([LineItemsAdjustableQuantity]).optional(),
...
'display': LineItemsDisplay.optional(),
'id': z.string(),
'metadata': z.record(z.string(), z.string()).optional(),
'object': z.enum(['item']),
...
export const MandateOptionsPayto = z.object({
'amount': z.number().int(),
'amount_type': z.enum(['fixed', 'maximum']),
'end_date': z.string(),
'payment_schedule': z.enum(['adhoc', 'annual', 'daily', 'fortnightly', 'monthly', 'quarterly', 'semi_annual', 'weekly']),
...
export type MandateOptionsPaytoModel = z.infer<typeof MandateOptionsPayto>;

export const CheckoutPaytoPaymentMethodOptions = z.object({
'mandate_options': MandateOptionsPayto.optional(),
'setup_future_usage': z.enum(['none', 'off_session']).optional()
});

export type CheckoutPaytoPaymentMethodOptionsModel = z.infer<typeof CheckoutPaytoPaymentMethodOptions>;
...
'payto': CheckoutPaytoPaymentMethodOptions.optional(),
...
export const PaymentPagesCheckoutSessionUpdatePermission = z.object({
'line_items': z.enum(['client_only', 'server_only']).optional(),
'shipping_details': z.enum(['client_only', 'server_only'])
});

export type PaymentPagesCheckoutSessionUpdatePermissionModel = z.infer<typeof PaymentPagesCheckoutSessionUpdatePermission>;

export const PaymentPagesCheckoutSessionPermissions = z.object({
'update': z.union([PaymentPagesCheckoutSessionUpdatePermission]).optional(),
'update_line_items': z.enum(['client_only', 'server_only']).optional(),
...
export const CustomerSubscriptionCollectionPaused = z.object({
'object': z.lazy(() => Subscription)
});

export type CustomerSubscriptionCollectionPausedModel = z.infer<typeof CustomerSubscriptionCollectionPaused>;

export const CustomerSubscriptionCollectionResumed = z.object({
'object': z.lazy(() => Subscription)
});

export type CustomerSubscriptionCollectionResumedModel = z.infer<typeof CustomerSubscriptionCollectionResumed>;
...
export const CustomerSubscriptionCustomEvent = z.object({
'object': z.lazy(() => Subscription)
});

export type CustomerSubscriptionCustomEventModel = z.infer<typeof CustomerSubscriptionCustomEvent>;
...
export const CustomerSubscriptionPriceMigrationFailed = z.object({
'object': z.lazy(() => Subscription)
});

export type CustomerSubscriptionPriceMigrationFailedModel = z.infer<typeof CustomerSubscriptionPriceMigrationFailed>;
...
export const CustomerSessionResourceTaxIdElementResourceFeatures = z.object({
'tax_id_redisplay': z.enum(['disabled', 'enabled']),
'tax_id_save': z.enum(['disabled', 'enabled'])
});

export type CustomerSessionResourceTaxIdElementResourceFeaturesModel = z.infer<typeof CustomerSessionResourceTaxIdElementResourceFeatures>;

export const CustomerSessionResourceTaxIdElement = z.object({
'enabled': z.boolean(),
'features': z.union([CustomerSessionResourceTaxIdElementResourceFeatures])
});

export type CustomerSessionResourceTaxIdElementModel = z.infer<typeof CustomerSessionResourceTaxIdElement>;
...
'tax_id_element': CustomerSessionResourceTaxIdElement.optional()
});
...
export const NotificationEventAutomationActionResourceSendWebhookCustomEvent = z.object({
'custom_data': z.record(z.string(), z.string())
});

export type NotificationEventAutomationActionResourceSendWebhookCustomEventModel = z.infer<typeof NotificationEventAutomationActionResourceSendWebhookCustomEvent>;

export const NotificationEventAutomationAction = z.object({
'stripe_send_webhook_custom_event': NotificationEventAutomationActionResourceSendWebhookCustomEvent.optional(),
'trigger': z.string(),
'type': z.enum(['stripe_send_webhook_custom_event'])
});

export type NotificationEventAutomationActionModel = z.infer<typeof NotificationEventAutomationAction>;
...
export const NotificationEventReason = z.object({
'automation_action': NotificationEventAutomationAction.optional(),
'request': NotificationEventRequest.optional(),
'type': z.enum(['automation_action', 'request'])
});

export type NotificationEventReasonModel = z.infer<typeof NotificationEventReason>;
...
'reason': z.union([NotificationEventReason]).optional(),
...
export const FinancialConnectionsInstitution = z.object({
'countries': z.array(z.string()),
'features': BankConnectionsResourceInstitutionFeatureSupport,
'id': z.string(),
'livemode': z.boolean(),
'name': z.string(),
'object': z.enum(['financial_connections.institution']),
'routing_numbers': z.array(z.string()),
'status': z.enum(['active', 'degraded', 'inactive']),
'url': z.string()
});

export type FinancialConnectionsInstitutionModel = z.infer<typeof FinancialConnectionsInstitution>;
...
'display_name': z.string(),
'id': z.string(),
'inferred_balances_refresh': z.union([BankConnectionsResourceInferredBalancesRefresh]).optional(),
'institution': z.union([z.string(), FinancialConnectionsInstitution]).optional(),
...
'subscriptions': z.array(z.enum(['balance', 'inferred_balances', 'transactions'])),
...
export const FinancialConnectionsAccountRefreshedInferredBalances = z.object({
'object': FinancialConnectionsAccount
});

export type FinancialConnectionsAccountRefreshedInferredBalancesModel = z.infer<typeof FinancialConnectionsAccountRefreshedInferredBalances>;
...
export const FinancialConnectionsAccountInferredBalance = z.object({
'as_of': z.number().int(),
'current': z.record(z.string(), z.number().int()),
'id': z.string(),
'object': z.enum(['financial_connections.account_inferred_balance'])
});

export type FinancialConnectionsAccountInferredBalanceModel = z.infer<typeof FinancialConnectionsAccountInferredBalance>;
...
'id': z.string(),
'limits': BankConnectionsResourceLinkAccountSessionLimits.optional(),
'livemode': z.boolean(),
'manual_entry': BankConnectionsResourceLinkAccountSessionManualEntry.optional(),
'object': z.enum(['financial_connections.session']),
'permissions': z.array(z.enum(['balances', 'ownership', 'payment_method', 'transactions'])),
'prefetch': z.array(z.enum(['balances', 'inferred_balances', 'ownership', 'transactions'])),
'return_url': z.string().optional(),
'status': z.enum(['cancelled', 'failed', 'pending', 'succeeded']).optional(),
'status_details': BankConnectionsResourceLinkAccountSessionStatusDetails.optional()
});

export type FinancialConnectionsSessionModel = z.infer<typeof FinancialConnectionsSession>;

export const FinancialConnectionsSessionUpdated = z.object({
'object': FinancialConnectionsSession
});

export type FinancialConnectionsSessionUpdatedModel = z.infer<typeof FinancialConnectionsSessionUpdated>;
...
export const FxQuoteRateDetails = z.object({
'base_rate': z.number(),
'duration_premium': z.number(),
'fx_fee_rate': z.number(),
'reference_rate': z.number(),
'reference_rate_provider': z.enum(['ecb'])
});

export type FxQuoteRateDetailsModel = z.infer<typeof FxQuoteRateDetails>;

export const FxQuoteRate = z.object({
'exchange_rate': z.number(),
'rate_details': FxQuoteRateDetails
});

export type FxQuoteRateModel = z.infer<typeof FxQuoteRate>;

export const FxQuoteUsagePayment = z.object({
'destination': z.string(),
'on_behalf_of': z.string()
});

export type FxQuoteUsagePaymentModel = z.infer<typeof FxQuoteUsagePayment>;

export const FxQuoteUsageTransfer = z.object({
'destination': z.string()
});

export type FxQuoteUsageTransferModel = z.infer<typeof FxQuoteUsageTransfer>;

export const FxQuoteUsage = z.object({
'payment': z.union([FxQuoteUsagePayment]),
'transfer': z.union([FxQuoteUsageTransfer]),
'type': z.enum(['payment', 'transfer'])
});

export type FxQuoteUsageModel = z.infer<typeof FxQuoteUsage>;

export const FxQuote = z.object({
'created': z.number().int(),
'id': z.string(),
'lock_duration': z.enum(['day', 'five_minutes', 'hour', 'none']),
'lock_expires_at': z.number().int(),
'lock_status': z.enum(['active', 'expired', 'none']),
'object': z.enum(['fx_quote']),
'rates': z.record(z.string(), FxQuoteRate),
'to_currency': z.string(),
'usage': FxQuoteUsage
});

export type FxQuoteModel = z.infer<typeof FxQuote>;

export const FxQuoteExpired = z.object({
'object': FxQuote
});

export type FxQuoteExpiredModel = z.infer<typeof FxQuoteExpired>;
...
export const InvoicePaymentOverpaid = z.object({
'object': z.lazy(() => InvoicePayment)
});

export type InvoicePaymentOverpaidModel = z.infer<typeof InvoicePaymentOverpaid>;
...
export type IssuingComplianceCreditUnderwritingRecordDecisionTypeCreditLimitDecreasedModel = z.infer<typeof IssuingComplianceCreditUnderwritingRecordDecisionTypeCreditLimitDecreased>;

export const IssuingComplianceCreditUnderwritingRecordDecisionTypeCreditLineClosed = z.object({
'reason_other_explanation': z.string(),
'reasons': z.array(z.enum(['applicant_is_not_beneficial_owner', 'applicant_too_young', 'application_is_not_beneficial_owner', 'bankruptcy', 'business_size_too_small', 'change_in_financial_state', 'change_in_utilization_of_credit_line', 'current_account_tier_ineligible', 'customer_already_exists', 'customer_requested_account_closure', 'debt_to_cash_balance_ratio_too_high', 'debt_to_equity_ratio_too_high', 'decrease_in_income_to_expense_ratio', 'decrease_in_social_media_performance', 'delinquent_credit_obligations', 'dispute_rate_too_high', 'duration_of_residence', 'exceeds_acceptable_platform_exposure', 'excessive_income_or_revenue_obligations', 'expenses_to_cash_balance_ratio_too_high', 'foreclosure_or_repossession', 'frozen_file_at_credit_bureau', 'garnishment_or_attachment', 'government_loan_program_criteria', 'has_recent_credit_limit_increase', 'high_concentration_of_clients', 'high_risk_industry', 'incomplete_application', 'inconsistent_monthly_revenues', 'insufficient_account_history_with_platform', 'insufficient_bank_account_history', 'insufficient_cash_balance', 'insufficient_cash_flow', 'insufficient_collateral', 'insufficient_credit_experience', 'insufficient_credit_utilization', 'insufficient_deposits', 'insufficient_income', 'insufficient_margin_ratio', 'insufficient_operating_profit', 'insufficient_period_in_operation', 'insufficient_reserves', 'insufficient_revenue', 'insufficient_social_media_performance', 'insufficient_time_in_network', 'insufficient_trade_credit_insurance', 'insufficient_usage_as_qualified_expenses', 'invalid_business_license', 'lacking_cash_account', 'late_payment_history_reported_to_bureau', 'lien_collection_action_or_judgement', 'negative_public_information', 'no_credit_file', 'other', 'outside_supported_country', 'outside_supported_state', 'poor_payment_history_with_platform', 'prior_or_current_legal_action', 'prohibited_industry', 'rate_of_cash_balance_fluctuation_too_high', 'recent_inquiries_on_business_credit_report', 'removal_of_bank_account_connection', 'revenue_discrepancy', 'runway_too_short', 'suspected_fraud', 'too_many_non_sufficient_funds_or_overdrafts', 'unable_to_verify_address', 'unable_to_verify_identity', 'unable_to_verify_income_or_revenue', 'unprofitable', 'unsupportable_business_type']))
});

export type IssuingComplianceCreditUnderwritingRecordDecisionTypeCreditLineClosedModel = z.infer<typeof IssuingComplianceCreditUnderwritingRecordDecisionTypeCreditLineClosed>;

export const IssuingComplianceCreditUnderwritingRecordDecision = z.object({
'application_rejected': z.union([IssuingComplianceCreditUnderwritingRecordDecisionTypeApplicationRejected]),
'credit_limit_approved': z.union([IssuingComplianceCreditUnderwritingRecordDecisionTypeCreditLimitApproved]),
'credit_limit_decreased': z.union([IssuingComplianceCreditUnderwritingRecordDecisionTypeCreditLimitDecreased]),
'credit_line_closed': z.union([IssuingComplianceCreditUnderwritingRecordDecisionTypeCreditLineClosed]),
'type': z.enum(['additional_information_requested', 'application_rejected', 'credit_limit_approved', 'credit_limit_decreased', 'credit_line_closed', 'no_changes', 'withdrawn_by_applicant'])
});

export type IssuingComplianceCreditUnderwritingRecordDecisionModel = z.infer<typeof IssuingComplianceCreditUnderwritingRecordDecision>;

export const IssuingComplianceCreditUnderwritingRecordUnderwritingException = z.object({
'explanation': z.string(),
'original_decision_type': z.enum(['additional_information_requested', 'application_rejected', 'credit_limit_approved', 'credit_limit_decreased', 'credit_line_closed', 'no_changes', 'withdrawn_by_applicant'])
});

export type IssuingComplianceCreditUnderwritingRecordUnderwritingExceptionModel = z.infer<typeof IssuingComplianceCreditUnderwritingRecordUnderwritingException>;

export const IssuingCreditUnderwritingRecord = z.object({
'application': z.union([IssuingComplianceCreditUnderwritingRecordApplication]),
'created': z.number().int(),
'created_from': z.enum(['application', 'proactive_review']),
'credit_user': IssuingComplianceCreditUnderwritingRecordCreditUser,
'decided_at': z.number().int(),
'decision': z.union([IssuingComplianceCreditUnderwritingRecordDecision]),
'decision_deadline': z.number().int(),
'id': z.string(),
'livemode': z.boolean(),
'metadata': z.record(z.string(), z.string()),
'object': z.enum(['issuing.credit_underwriting_record']),
'regulatory_reporting_file': z.string(),
'underwriting_exception': z.union([IssuingComplianceCreditUnderwritingRecordUnderwritingException])
});

export type IssuingCreditUnderwritingRecordModel = z.infer<typeof IssuingCreditUnderwritingRecord>;

export const IssuingDisputeSettlementDetailNetworkData = z.object({
'processing_date': z.string()
});

export type IssuingDisputeSettlementDetailNetworkDataModel = z.infer<typeof IssuingDisputeSettlementDetailNetworkData>;

export const IssuingDisputeSettlementDetail = z.object({
'amount': z.number().int(),
'card': z.string(),
'created': z.number().int(),
'currency': z.string(),
'dispute': z.string(),
'event_type': z.enum(['filing', 'loss', 'representment', 'win']),
'id': z.string(),
'livemode': z.boolean(),
'network': z.enum(['maestro', 'mastercard', 'visa']),
'network_data': z.union([IssuingDisputeSettlementDetailNetworkData]),
'object': z.enum(['issuing.dispute_settlement_detail']),
'settlement': z.string()
});

export type IssuingDisputeSettlementDetailModel = z.infer<typeof IssuingDisputeSettlementDetail>;

export const IssuingFraudLiabilityDebit = z.object({
'amount': z.number().int(),
'balance_transaction': z.union([z.string(), z.lazy(() => BalanceTransaction)]),
'created': z.number().int(),
'currency': z.string(),
...
'id': z.string(),
'livemode': z.boolean(),
'object': z.enum(['issuing.fraud_liability_debit'])
});

export type IssuingFraudLiabilityDebitModel = z.infer<typeof IssuingFraudLiabilityDebit>;
...
export const IssuingDisputeSettlementDetailCreated = z.object({
'object': IssuingDisputeSettlementDetail
});

export type IssuingDisputeSettlementDetailCreatedModel = z.infer<typeof IssuingDisputeSettlementDetailCreated>;

export const IssuingDisputeSettlementDetailUpdated = z.object({
'object': IssuingDisputeSettlementDetail
});

export type IssuingDisputeSettlementDetailUpdatedModel = z.infer<typeof IssuingDisputeSettlementDetailUpdated>;

export const IssuingFraudLiabilityDebitCreated = z.object({
'object': IssuingFraudLiabilityDebit
});

export type IssuingFraudLiabilityDebitCreatedModel = z.infer<typeof IssuingFraudLiabilityDebitCreated>;
...
export const IssuingSettlementCreated = z.object({
'object': IssuingSettlement
});

export type IssuingSettlementCreatedModel = z.infer<typeof IssuingSettlementCreated>;

export const IssuingSettlementUpdated = z.object({
'object': IssuingSettlement
});

export type IssuingSettlementUpdatedModel = z.infer<typeof IssuingSettlementUpdated>;
...
export const OrdersV2ResourceAutomaticTax = z.object({
'enabled': z.boolean(),
'status': z.enum(['complete', 'failed', 'requires_location_inputs'])
});

export type OrdersV2ResourceAutomaticTaxModel = z.infer<typeof OrdersV2ResourceAutomaticTax>;

export const OrdersV2ResourceBillingDetails = z.object({
'address': z.union([Address]),
'email': z.string(),
'name': z.string(),
'phone': z.string()
...
export type OrdersV2ResourceBillingDetailsModel = z.infer<typeof OrdersV2ResourceBillingDetails>;

export const OrdersV2ResourceAutomaticPaymentMethods = z.object({
'enabled': z.boolean()
});

export type OrdersV2ResourceAutomaticPaymentMethodsModel = z.infer<typeof OrdersV2ResourceAutomaticPaymentMethods>;

export const OrdersPaymentMethodOptionsAfterpayClearpay = z.object({
'capture_method': z.enum(['automatic', 'automatic_async', 'manual']).optional(),
'reference': z.string(),
'setup_future_usage': z.enum(['none']).optional()
});

export type OrdersPaymentMethodOptionsAfterpayClearpayModel = z.infer<typeof OrdersPaymentMethodOptionsAfterpayClearpay>;

export const OrdersV2ResourceCardPaymentMethodOptions = z.object({
'capture_method': z.enum(['automatic', 'automatic_async', 'manual']),
'setup_future_usage': z.enum(['none', 'off_session', 'on_session']).optional()
});

export type OrdersV2ResourceCardPaymentMethodOptionsModel = z.infer<typeof OrdersV2ResourceCardPaymentMethodOptions>;

export const OrdersV2ResourcePaymentMethodOptions = z.object({
'acss_debit': PaymentIntentPaymentMethodOptionsAcssDebit.optional(),
'afterpay_clearpay': OrdersPaymentMethodOptionsAfterpayClearpay.optional(),
'alipay': PaymentMethodOptionsAlipay.optional(),
'bancontact': PaymentMethodOptionsBancontact.optional(),
'card': OrdersV2ResourceCardPaymentMethodOptions.optional(),
'customer_balance': PaymentMethodOptionsCustomerBalance.optional(),
'ideal': PaymentMethodOptionsIdeal.optional(),
'klarna': PaymentMethodOptionsKlarna.optional(),
'link': PaymentIntentPaymentMethodOptionsLink.optional(),
...
export type OrdersV2ResourcePaymentMethodOptionsModel = z.infer<typeof OrdersV2ResourcePaymentMethodOptions>;

export const OrdersV2ResourceTransferData = z.object({
'amount': z.number().int(),
'destination': z.union([z.string(), z.lazy(() => Account)])
});

export type OrdersV2ResourceTransferDataModel = z.infer<typeof OrdersV2ResourceTransferData>;

export const OrdersV2ResourcePaymentSettings = z.object({
'application_fee_amount': z.number().int(),
'automatic_payment_methods': z.union([OrdersV2ResourceAutomaticPaymentMethods]),
'payment_method_options': z.union([OrdersV2ResourcePaymentMethodOptions]),
'payment_method_types': z.array(z.enum(['acss_debit', 'afterpay_clearpay', 'alipay', 'au_becs_debit', 'bacs_debit', 'bancontact', 'card', 'customer_balance', 'eps', 'fpx', 'giropay', 'grabpay', 'ideal', 'klarna', 'link', 'oxxo', 'p24', 'paypal', 'sepa_debit', 'sofort', 'wechat_pay'])),
'return_url': z.string(),
'statement_descriptor': z.string(),
'statement_descriptor_suffix': z.string(),
'transfer_data': z.union([OrdersV2ResourceTransferData])
});

export type OrdersV2ResourcePaymentSettingsModel = z.infer<typeof OrdersV2ResourcePaymentSettings>;

export const OrdersV2ResourcePayment = z.object({
'payment_intent': z.union([z.string(), z.lazy(() => PaymentIntent)]),
'settings': z.union([OrdersV2ResourcePaymentSettings]),
'status': z.enum(['canceled', 'complete', 'not_required', 'processing', 'requires_action', 'requires_capture', 'requires_confirmation', 'requires_payment_method'])
});

export type OrdersV2ResourcePaymentModel = z.infer<typeof OrdersV2ResourcePayment>;

export const OrdersV2ResourceShippingCost = z.object({
'amount_subtotal': z.number().int(),
'amount_tax': z.number().int(),
'amount_total': z.number().int(),
'shipping_rate': z.union([z.string(), ShippingRate]),
...
export type OrdersV2ResourceShippingCostModel = z.infer<typeof OrdersV2ResourceShippingCost>;

export const OrdersV2ResourceShippingDetails = z.object({
'address': z.union([Address]),
'name': z.string(),
'phone': z.string()
});

export type OrdersV2ResourceShippingDetailsModel = z.infer<typeof OrdersV2ResourceShippingDetails>;

export const OrdersV2ResourceTaxDetailsResourceTaxId = z.object({
'type': z.enum(['ad_nrt', 'ae_trn', 'al_tin', 'am_tin', 'ao_tin', 'ar_cuit', 'au_abn', 'au_arn', 'aw_tin', 'az_tin', 'ba_tin', 'bb_tin', 'bd_bin', 'bf_ifu', 'bg_uic', 'bh_vat', 'bj_ifu', 'bo_tin', 'br_cnpj', 'br_cpf', 'bs_tin', 'by_tin', 'ca_bn', 'ca_gst_hst', 'ca_pst_bc', 'ca_pst_mb', 'ca_pst_sk', 'ca_qst', 'cd_nif', 'ch_uid', 'ch_vat', 'cl_tin', 'cm_niu', 'cn_tin', 'co_nit', 'cr_tin', 'cv_nif', 'de_stn', 'do_rcn', 'ec_ruc', 'eg_tin', 'es_cif', 'et_tin', 'eu_oss_vat', 'eu_vat', 'gb_vat', 'ge_vat', 'gn_nif', 'hk_br', 'hr_oib', 'hu_tin', 'id_npwp', 'il_vat', 'in_gst', 'is_vat', 'jp_cn', 'jp_rn', 'jp_trn', 'ke_pin', 'kg_tin', 'kh_tin', 'kr_brn', 'kz_bin', 'la_tin', 'li_uid', 'li_vat', 'ma_vat', 'md_vat', 'me_pib', 'mk_vat', 'mr_nif', 'mx_rfc', 'my_frp', 'my_itn', 'my_sst', 'ng_tin', 'no_vat', 'no_voec', 'np_pan', 'nz_gst', 'om_vat', 'pe_ruc', 'ph_tin', 'ro_tin', 'rs_pib', 'ru_inn', 'ru_kpp', 'sa_vat', 'sg_gst', 'sg_uen', 'si_tin', 'sn_ninea', 'sr_fin', 'sv_nit', 'th_vat', 'tj_tin', 'tr_tin', 'tw_vat', 'tz_vat', 'ua_vat', 'ug_tin', 'unknown', 'us_ein', 'uy_ruc', 'uz_tin', 'uz_vat', 've_rif', 'vn_tin', 'za_vat', 'zm_tin', 'zw_tin']),
'value': z.string()
});

export type OrdersV2ResourceTaxDetailsResourceTaxIdModel = z.infer<typeof OrdersV2ResourceTaxDetailsResourceTaxId>;

export const OrdersV2ResourceTaxDetails = z.object({
'tax_exempt': z.enum(['exempt', 'none', 'reverse']),
'tax_ids': z.array(OrdersV2ResourceTaxDetailsResourceTaxId)
});

export type OrdersV2ResourceTaxDetailsModel = z.infer<typeof OrdersV2ResourceTaxDetails>;

export const OrdersV2ResourceTotalDetailsApiResourceBreakdown = z.object({
'discounts': z.array(LineItemsDiscountAmount),
'taxes': z.array(LineItemsTaxAmount)
});

export type OrdersV2ResourceTotalDetailsApiResourceBreakdownModel = z.infer<typeof OrdersV2ResourceTotalDetailsApiResourceBreakdown>;

export const OrdersV2ResourceTotalDetails = z.object({
'amount_discount': z.number().int(),
'amount_shipping': z.number().int(),
'amount_tax': z.number().int(),
'breakdown': OrdersV2ResourceTotalDetailsApiResourceBreakdown.optional()
});

export type OrdersV2ResourceTotalDetailsModel = z.infer<typeof OrdersV2ResourceTotalDetails>;

export const Order = z.object({
'amount_subtotal': z.number().int(),
'amount_total': z.number().int(),
'application': z.union([z.string(), Application]),
'automatic_tax': OrdersV2ResourceAutomaticTax.optional(),
'billing_details': z.union([OrdersV2ResourceBillingDetails]),
'client_secret': z.string(),
'created': z.number().int(),
'currency': z.string(),
'customer': z.union([z.string(), z.lazy(() => Customer), DeletedCustomer]),
...
'shipping_cost': z.union([OrdersV2ResourceShippingCost]),
'shipping_details': z.union([OrdersV2ResourceShippingDetails]),
'status': z.enum(['canceled', 'complete', 'open', 'processing', 'submitted']),
'tax_details': OrdersV2ResourceTaxDetails.optional(),
...
'gopay': PaymentMethodConfigResourcePaymentMethodProperties.optional(),
'grabpay': PaymentMethodConfigResourcePaymentMethodProperties.optional(),
'id': z.string(),
'id_bank_transfer': PaymentMethodConfigResourcePaymentMethodProperties.optional(),
...
'paypay': PaymentMethodConfigResourcePaymentMethodProperties.optional(),
'payto': PaymentMethodConfigResourcePaymentMethodProperties.optional(),
...
'qris': PaymentMethodConfigResourcePaymentMethodProperties.optional(),
...
'shopeepay': PaymentMethodConfigResourcePaymentMethodProperties.optional(),
...
export const RedactionResourceRootObjects = z.object({
'charges': z.array(z.string()),
'checkout_sessions': z.array(z.string()),
'customers': z.array(z.string()),
'identity_verification_sessions': z.array(z.string()),
'invoices': z.array(z.string()),
'issuing_cardholders': z.array(z.string()),
'payment_intents': z.array(z.string()),
'radar_value_list_items': z.array(z.string()),
'setup_intents': z.array(z.string())
});

export type RedactionResourceRootObjectsModel = z.infer<typeof RedactionResourceRootObjects>;

export const PrivacyRedactionJob = z.object({
'created': z.number().int(),
'id': z.string(),
'livemode': z.boolean(),
'object': z.enum(['privacy.redaction_job']),
'objects': z.union([RedactionResourceRootObjects]).optional(),
'status': z.enum(['canceled', 'canceling', 'created', 'failed', 'ready', 'redacting', 'succeeded', 'validating']),
'validation_behavior': z.enum(['error', 'fix'])
});

export type PrivacyRedactionJobModel = z.infer<typeof PrivacyRedactionJob>;

export const PrivacyRedactionJobCanceled = z.object({
'object': PrivacyRedactionJob
});

export type PrivacyRedactionJobCanceledModel = z.infer<typeof PrivacyRedactionJobCanceled>;

export const PrivacyRedactionJobCreated = z.object({
'object': PrivacyRedactionJob
});

export type PrivacyRedactionJobCreatedModel = z.infer<typeof PrivacyRedactionJobCreated>;

export const PrivacyRedactionJobReady = z.object({
'object': PrivacyRedactionJob
});

export type PrivacyRedactionJobReadyModel = z.infer<typeof PrivacyRedactionJobReady>;

export const PrivacyRedactionJobSucceeded = z.object({
'object': PrivacyRedactionJob
});

export type PrivacyRedactionJobSucceededModel = z.infer<typeof PrivacyRedactionJobSucceeded>;

export const PrivacyRedactionJobValidationError = z.object({
'object': PrivacyRedactionJob
});

export type PrivacyRedactionJobValidationErrorModel = z.infer<typeof PrivacyRedactionJobValidationError>;

export const RedactionResourceErroringObject = z.object({
'id': z.string(),
'object_type': z.string()
});

export type RedactionResourceErroringObjectModel = z.infer<typeof RedactionResourceErroringObject>;

export const PrivacyRedactionJobValidationError_1 = z.object({
'code': z.enum(['invalid_cascading_source', 'invalid_file_purpose', 'invalid_state', 'locked_by_other_job', 'too_many_objects']),
'erroring_object': z.union([RedactionResourceErroringObject]),
'id': z.string(),
'message': z.string(),
'object': z.enum(['privacy.redaction_job_validation_error'])
});

export type PrivacyRedactionJobValidationError_1Model = z.infer<typeof PrivacyRedactionJobValidationError_1>;
...
export const QuotesCoreApiResourceReestimateFailure = z.object({
'failure_code': z.string(),
'message': z.string(),
'reason': z.enum(['automation_failure', 'internal_error'])
});

export type QuotesCoreApiResourceReestimateFailureModel = z.infer<typeof QuotesCoreApiResourceReestimateFailure>;

export const QuotesCoreApiResourceLastReestimateDetails = z.object({
'failed': z.union([QuotesCoreApiResourceReestimateFailure]),
'status': z.enum(['failed', 'in_progress', 'succeeded'])
});

export type QuotesCoreApiResourceLastReestimateDetailsModel = z.infer<typeof QuotesCoreApiResourceLastReestimateDetails>;
...
'last_reestimation_details': z.union([QuotesCoreApiResourceLastReestimateDetails]).optional(),
...
export const QuotesResourceStatusDetailsCanceledStatusDetails = z.object({
'reason': z.enum(['canceled', 'quote_accepted', 'quote_expired', 'quote_superseded', 'subscription_canceled']),
'transitioned_at': z.number().int()
});

export type QuotesResourceStatusDetailsCanceledStatusDetailsModel = z.infer<typeof QuotesResourceStatusDetailsCanceledStatusDetails>;

export const QuotesResourceStatusDetailsLinesInvalid = z.object({
'invalid_at': z.number().int(),
'lines': z.array(z.string())
});

export type QuotesResourceStatusDetailsLinesInvalidModel = z.infer<typeof QuotesResourceStatusDetailsLinesInvalid>;

export const QuotesResourceStatusDetailsSubscriptionChanged = z.object({
'previous_subscription': z.union([z.lazy(() => Subscription)])
});

export type QuotesResourceStatusDetailsSubscriptionChangedModel = z.infer<typeof QuotesResourceStatusDetailsSubscriptionChanged>;

export const QuotesResourceStatusDetailsSubscriptionScheduleChanged = z.object({
'previous_subscription_schedule': z.union([z.lazy(() => SubscriptionSchedule)])
});

export type QuotesResourceStatusDetailsSubscriptionScheduleChangedModel = z.infer<typeof QuotesResourceStatusDetailsSubscriptionScheduleChanged>;

export const QuotesResourceStatusDetailsStaleReason = z.object({
'line_invalid': z.string().optional(),
'lines_invalid': z.array(QuotesResourceStatusDetailsLinesInvalid).optional(),
'marked_stale': z.string().optional(),
'subscription_canceled': z.string().optional(),
'subscription_changed': QuotesResourceStatusDetailsSubscriptionChanged.optional(),
'subscription_expired': z.string().optional(),
'subscription_schedule_canceled': z.string().optional(),
'subscription_schedule_changed': QuotesResourceStatusDetailsSubscriptionScheduleChanged.optional(),
'subscription_schedule_released': z.string().optional(),
'type': z.enum(['accept_failed_validations', 'bill_on_acceptance_invalid', 'line_invalid', 'lines_invalid', 'marked_stale', 'subscription_canceled', 'subscription_changed', 'subscription_expired', 'subscription_schedule_canceled', 'subscription_schedule_changed', 'subscription_schedule_released'])
});

export type QuotesResourceStatusDetailsStaleReasonModel = z.infer<typeof QuotesResourceStatusDetailsStaleReason>;

export const QuotesResourceStatusDetailsStaleStatusDetails = z.object({
'expires_at': z.number().int(),
'last_reason': z.union([QuotesResourceStatusDetailsStaleReason]),
'last_updated_at': z.number().int(),
'transitioned_at': z.number().int()
});

export type QuotesResourceStatusDetailsStaleStatusDetailsModel = z.infer<typeof QuotesResourceStatusDetailsStaleStatusDetails>;

export const QuotesResourceStatusDetailsStatusDetails = z.object({
'canceled': QuotesResourceStatusDetailsCanceledStatusDetails.optional(),
'stale': QuotesResourceStatusDetailsStaleStatusDetails.optional()
});

export type QuotesResourceStatusDetailsStatusDetailsModel = z.infer<typeof QuotesResourceStatusDetailsStatusDetails>;
...
export const QuotesResourceQuoteLinesTimestampHelpersLineId = z.object({
'id': z.string()
});

export type QuotesResourceQuoteLinesTimestampHelpersLineIdModel = z.infer<typeof QuotesResourceQuoteLinesTimestampHelpersLineId>;

export const QuotesResourceSubscriptionDataBillFrom = z.object({
'computed': z.number().int(),
'line_starts_at': z.union([QuotesResourceQuoteLinesTimestampHelpersLineId]),
'timestamp': z.number().int(),
'type': z.enum(['line_starts_at', 'now', 'pause_collection_start', 'quote_acceptance_date', 'timestamp'])
});

export type QuotesResourceSubscriptionDataBillFromModel = z.infer<typeof QuotesResourceSubscriptionDataBillFrom>;

export const QuotesResourceQuoteLinesTimestampHelpersDuration = z.object({
'interval': z.enum(['day', 'month', 'week', 'year']),
'interval_count': z.number().int()
});

export type QuotesResourceQuoteLinesTimestampHelpersDurationModel = z.infer<typeof QuotesResourceQuoteLinesTimestampHelpersDuration>;

export const QuotesResourceSubscriptionDataBillUntil = z.object({
'computed': z.number().int(),
'duration': z.union([QuotesResourceQuoteLinesTimestampHelpersDuration]),
'line_ends_at': z.union([QuotesResourceQuoteLinesTimestampHelpersLineId]),
'timestamp': z.number().int(),
'type': z.enum(['duration', 'line_ends_at', 'schedule_end', 'timestamp', 'upcoming_invoice'])
});

export type QuotesResourceSubscriptionDataBillUntilModel = z.infer<typeof QuotesResourceSubscriptionDataBillUntil>;

export const QuotesResourceSubscriptionDataBillOnAcceptance = z.object({
'bill_from': z.union([QuotesResourceSubscriptionDataBillFrom]),
'bill_until': z.union([QuotesResourceSubscriptionDataBillUntil])
});

export type QuotesResourceSubscriptionDataBillOnAcceptanceModel = z.infer<typeof QuotesResourceSubscriptionDataBillOnAcceptance>;
...
export const QuotesResourcePrebilling = z.object({
'iterations': z.number().int()
});

export type QuotesResourcePrebillingModel = z.infer<typeof QuotesResourcePrebilling>;

export const QuotesResourceSubscriptionDataSubscriptionData = z.object({
'bill_on_acceptance': z.union([QuotesResourceSubscriptionDataBillOnAcceptance]).optional(),
'billing_behavior': z.enum(['prorate_on_next_phase', 'prorate_up_front']).optional(),
'billing_cycle_anchor': z.enum(['reset']).optional(),
...
'from_subscription': z.union([z.string(), z.lazy(() => Subscription)]).optional(),
'metadata': z.record(z.string(), z.string()),
'prebilling': z.union([QuotesResourcePrebilling]).optional(),
...
export const QuotesResourceQuoteLinesAppliesTo = z.object({
'new_reference': z.string(),
'subscription_schedule': z.string(),
'type': z.enum(['new_reference', 'subscription_schedule'])
});

export type QuotesResourceQuoteLinesAppliesToModel = z.infer<typeof QuotesResourceQuoteLinesAppliesTo>;

export const QuotesResourceSubscriptionDataSubscriptionDataOverrides = z.object({
'applies_to': QuotesResourceQuoteLinesAppliesTo,
'bill_on_acceptance': z.union([QuotesResourceSubscriptionDataBillOnAcceptance]).optional(),
'billing_behavior': z.enum(['prorate_on_next_phase', 'prorate_up_front']).optional(),
'customer': z.string(),
'description': z.string(),
...
export type QuotesResourceSubscriptionDataSubscriptionDataOverridesModel = z.infer<typeof QuotesResourceSubscriptionDataSubscriptionDataOverrides>;

export const QuotesResourceSubscriptionScheduleWithAppliesTo = z.object({
'applies_to': QuotesResourceQuoteLinesAppliesTo,
'subscription_schedule': z.string()
});

export type QuotesResourceSubscriptionScheduleWithAppliesToModel = z.infer<typeof QuotesResourceSubscriptionScheduleWithAppliesTo>;
...
'allow_backdated_lines': z.boolean().optional(),
'amount_subtotal': z.number().int(),
'amount_total': z.number().int(),
'application': z.union([z.string(), Application, DeletedApplication]),
'application_fee_amount': z.number().int(),
...
'object': z.enum(['quote']),
'on_behalf_of': z.union([z.string(), z.lazy(() => Account)]),
'status': z.enum(['accepted', 'accepting', 'canceled', 'draft', 'open', 'stale']),
'status_details': z.union([QuotesResourceStatusDetailsStatusDetails]).optional(),
'status_transitions': QuotesResourceStatusTransitions,
'subscription': z.union([z.string(), z.lazy(() => Subscription)]),
'subscription_data': QuotesResourceSubscriptionDataSubscriptionData,
'subscription_data_overrides': z.array(QuotesResourceSubscriptionDataSubscriptionDataOverrides).optional(),
'subscription_schedule': z.union([z.string(), z.lazy(() => SubscriptionSchedule)]),
'subscription_schedules': z.array(QuotesResourceSubscriptionScheduleWithAppliesTo).optional(),
'test_clock': z.union([z.string(), TestHelpersTestClock]),
'total_details': QuotesResourceTotalDetails,
'transfer_data': z.union([QuotesResourceTransferData])
});

export const QuoteAcceptFailed = z.object({
'object': z.lazy(() => Quote)
});

export type QuoteAcceptFailedModel = z.infer<typeof QuoteAcceptFailed>;
...
export const QuoteAccepting = z.object({
'object': z.lazy(() => Quote)
});

export type QuoteAcceptingModel = z.infer<typeof QuoteAccepting>;
...
export type QuoteDraftModel = z.infer<typeof QuoteDraft>;
...
export const QuoteReestimateFailed = z.object({
'object': z.lazy(() => Quote)
});

export type QuoteReestimateFailedModel = z.infer<typeof QuoteReestimateFailed>;

export const QuoteReestimated = z.object({
'object': z.lazy(() => Quote)
});

export type QuoteReestimatedModel = z.infer<typeof QuoteReestimated>;

export const QuoteStale = z.object({
'object': z.lazy(() => Quote)
});

export type QuoteStaleModel = z.infer<typeof QuoteStale>;

export const QuoteLineDiscountEnd = z.object({
'type': z.enum(['line_ends_at'])
});

export type QuoteLineDiscountEndModel = z.infer<typeof QuoteLineDiscountEnd>;

export const StackableDiscountWithIndexAndDiscountEnd = z.object({
'coupon': z.union([z.string(), Coupon]),
'discount': z.union([z.string(), z.lazy(() => Discount)]),
'discount_end': z.union([QuoteLineDiscountEnd]).optional(),
'index': z.number().int(),
'promotion_code': z.union([z.string(), z.lazy(() => PromotionCode)])
});

export type StackableDiscountWithIndexAndDiscountEndModel = z.infer<typeof StackableDiscountWithIndexAndDiscountEnd>;

export const QuotesResourceQuoteLinesTrial = z.object({
'converts_to': z.array(z.string()).optional(),
'type': z.enum(['free', 'paid'])
});

export type QuotesResourceQuoteLinesTrialModel = z.infer<typeof QuotesResourceQuoteLinesTrial>;

export const QuotesResourceQuoteLinesActionsConfigurationItem = z.object({
'discounts': z.array(DiscountsResourceStackableDiscount),
'metadata': z.record(z.string(), z.string()),
'price': z.union([z.string(), z.lazy(() => Price), DeletedPrice]),
'quantity': z.number().int().optional(),
'tax_rates': z.array(TaxRate).optional(),
'trial': z.union([QuotesResourceQuoteLinesTrial]).optional()
});

export type QuotesResourceQuoteLinesActionsConfigurationItemModel = z.infer<typeof QuotesResourceQuoteLinesActionsConfigurationItem>;

export const QuotesResourceQuoteLinesActionsRemoveItem = z.object({
'price': z.union([z.string(), z.lazy(() => Price), DeletedPrice])
});

export type QuotesResourceQuoteLinesActionsRemoveItemModel = z.infer<typeof QuotesResourceQuoteLinesActionsRemoveItem>;

export const QuoteLineAction = z.object({
'add_discount': z.union([StackableDiscountWithIndexAndDiscountEnd]),
'add_item': z.union([QuotesResourceQuoteLinesActionsConfigurationItem]),
'add_metadata': z.record(z.string(), z.string()),
'remove_discount': z.union([DiscountsResourceStackableDiscount]),
'remove_item': z.union([QuotesResourceQuoteLinesActionsRemoveItem]),
'remove_metadata': z.array(z.string()),
'set_discounts': z.array(DiscountsResourceStackableDiscount),
'set_items': z.array(QuotesResourceQuoteLinesActionsConfigurationItem),
'set_metadata': z.record(z.string(), z.string()),
'type': z.enum(['add_discount', 'add_item', 'add_metadata', 'clear_discounts', 'clear_metadata', 'remove_discount', 'remove_item', 'remove_metadata', 'set_discounts', 'set_items', 'set_metadata'])
});

export type QuoteLineActionModel = z.infer<typeof QuoteLineAction>;

export const QuotesResourceQuoteLinesCancelSubscriptionSchedule = z.object({
'cancel_at': z.enum(['line_starts_at']),
'invoice_now': z.boolean(),
'prorate': z.boolean()
});

export type QuotesResourceQuoteLinesCancelSubscriptionScheduleModel = z.infer<typeof QuotesResourceQuoteLinesCancelSubscriptionSchedule>;

export const QuotesResourceQuoteLinesTimestampHelpersDiscountEnd = z.object({
'discount': z.string()
});

export type QuotesResourceQuoteLinesTimestampHelpersDiscountEndModel = z.infer<typeof QuotesResourceQuoteLinesTimestampHelpersDiscountEnd>;

export const QuotesResourceQuoteLinesTimestampHelpersEndsAt = z.object({
'computed': z.number().int(),
'discount_end': z.union([QuotesResourceQuoteLinesTimestampHelpersDiscountEnd]).optional(),
'duration': z.union([QuotesResourceQuoteLinesTimestampHelpersDuration]),
'timestamp': z.number().int(),
'type': z.enum(['billing_period_end', 'discount_end', 'duration', 'quote_acceptance_date', 'schedule_end', 'timestamp', 'upcoming_invoice'])
});

export type QuotesResourceQuoteLinesTimestampHelpersEndsAtModel = z.infer<typeof QuotesResourceQuoteLinesTimestampHelpersEndsAt>;

export const QuotesResourceQuoteLinesSetPauseCollection = z.object({
'set': z.union([SubscriptionSchedulesResourcePauseCollection]).optional(),
'type': z.enum(['remove', 'set'])
});

export type QuotesResourceQuoteLinesSetPauseCollectionModel = z.infer<typeof QuotesResourceQuoteLinesSetPauseCollection>;

export const QuotesResourceQuoteLinesTimestampHelpersStartsAt = z.object({
'computed': z.number().int(),
'discount_end': z.union([QuotesResourceQuoteLinesTimestampHelpersDiscountEnd]).optional(),
'line_ends_at': z.union([QuotesResourceQuoteLinesTimestampHelpersLineId]),
'timestamp': z.number().int(),
'type': z.enum(['discount_end', 'line_ends_at', 'now', 'quote_acceptance_date', 'schedule_end', 'timestamp', 'upcoming_invoice'])
});

export type QuotesResourceQuoteLinesTimestampHelpersStartsAtModel = z.infer<typeof QuotesResourceQuoteLinesTimestampHelpersStartsAt>;

export const QuotesResourceQuoteLinesEndBehavior = z.object({
'prorate_up_front': z.enum(['defer', 'include'])
});

export type QuotesResourceQuoteLinesEndBehaviorModel = z.infer<typeof QuotesResourceQuoteLinesEndBehavior>;

export const QuotesResourceQuoteLinesTrialSettings = z.object({
'end_behavior': z.union([QuotesResourceQuoteLinesEndBehavior])
});

export type QuotesResourceQuoteLinesTrialSettingsModel = z.infer<typeof QuotesResourceQuoteLinesTrialSettings>;

export const QuoteLine = z.object({
'actions': z.array(QuoteLineAction).optional(),
'applies_to': z.union([QuotesResourceQuoteLinesAppliesTo]),
'billing_cycle_anchor': z.enum(['automatic', 'line_starts_at']),
'cancel_subscription_schedule': z.union([QuotesResourceQuoteLinesCancelSubscriptionSchedule]),
'ends_at': z.union([QuotesResourceQuoteLinesTimestampHelpersEndsAt]),
'id': z.string(),
'object': z.enum(['quote_line']),
'proration_behavior': z.enum(['always_invoice', 'create_prorations', 'none']),
'set_pause_collection': z.union([QuotesResourceQuoteLinesSetPauseCollection]).optional(),
'set_schedule_end': z.enum(['line_ends_at', 'line_starts_at']),
'starts_at': z.union([QuotesResourceQuoteLinesTimestampHelpersStartsAt]),
'trial_settings': z.union([QuotesResourceQuoteLinesTrialSettings]).optional()
});

export type QuoteLineModel = z.infer<typeof QuoteLine>;

export const QuotePreviewInvoice = z.object({
'account_country': z.string(),
'account_name': z.string(),
'account_tax_ids': z.array(z.union([z.string(), z.lazy(() => TaxId), DeletedTaxId])),
'amount_due': z.number().int(),
...
'next_payment_attempt': z.number().int(),
'number': z.string(),
'object': z.enum(['quote_preview_invoice']),
'on_behalf_of': z.union([z.string(), z.lazy(() => Account)]),
'parent': z.union([z.lazy(() => BillingBillResourceInvoicingParentsInvoiceParent)]),
'payment_settings': InvoicesPaymentSettings,
'payments': z.object({
...
export type QuotePreviewInvoiceModel = z.infer<typeof QuotePreviewInvoice>;

export const QuotePreviewSubscriptionSchedule = z.object({
'application': z.union([z.string(), Application, DeletedApplication]),
'applies_to': QuotesResourceQuoteLinesAppliesTo,
'billing_behavior': z.enum(['prorate_on_next_phase', 'prorate_up_front']).optional(),
'billing_mode': SubscriptionsResourceBillingMode,
...
'livemode': z.boolean(),
'metadata': z.record(z.string(), z.string()),
'object': z.enum(['quote_preview_subscription_schedule']),
'phases': z.array(z.lazy(() => SubscriptionSchedulePhaseConfiguration)),
'prebilling': z.union([SubscriptionPrebillingData]).optional(),
'released_at': z.number().int(),
'released_subscription': z.string(),
...
export type QuotePreviewSubscriptionScheduleModel = z.infer<typeof QuotePreviewSubscriptionSchedule>;
...
export const SubscriptionSchedulePriceMigrationFailed = z.object({
'object': z.lazy(() => SubscriptionSchedule)
});

export type SubscriptionSchedulePriceMigrationFailedModel = z.infer<typeof SubscriptionSchedulePriceMigrationFailed>;
...
export const TaxReportingResourceTaxFormAuSerr = z.object({
'reporting_period_end_date': z.string(),
'reporting_period_start_date': z.string()
});

export type TaxReportingResourceTaxFormAuSerrModel = z.infer<typeof TaxReportingResourceTaxFormAuSerr>;

export const TaxReportingResourceTaxFormCaMrdp = z.object({
'reporting_period_end_date': z.string(),
'reporting_period_start_date': z.string()
});

export type TaxReportingResourceTaxFormCaMrdpModel = z.infer<typeof TaxReportingResourceTaxFormCaMrdp>;

export const TaxReportingResourceTaxFormEuDac7 = z.object({
'reporting_period_end_date': z.string(),
'reporting_period_start_date': z.string()
});

export type TaxReportingResourceTaxFormEuDac7Model = z.infer<typeof TaxReportingResourceTaxFormEuDac7>;

export const TaxReportingResourceTaxFormFilingStatusResourceJurisdiction = z.object({
'country': z.string(),
'level': z.enum(['country', 'state']),
'state': z.string()
});

export type TaxReportingResourceTaxFormFilingStatusResourceJurisdictionModel = z.infer<typeof TaxReportingResourceTaxFormFilingStatusResourceJurisdiction>;

export const TaxReportingResourceTaxFormFilingStatus = z.object({
'effective_at': z.number().int(),
'jurisdiction': TaxReportingResourceTaxFormFilingStatusResourceJurisdiction,
'value': z.enum(['accepted', 'filed', 'rejected'])
});

export type TaxReportingResourceTaxFormFilingStatusModel = z.infer<typeof TaxReportingResourceTaxFormFilingStatus>;

export const TaxReportingResourceTaxFormGbMrdp = z.object({
'reporting_period_end_date': z.string(),
'reporting_period_start_date': z.string()
});

export type TaxReportingResourceTaxFormGbMrdpModel = z.infer<typeof TaxReportingResourceTaxFormGbMrdp>;

export const TaxReportingResourceTaxFormNzMrdp = z.object({
'reporting_period_end_date': z.string(),
'reporting_period_start_date': z.string()
});

export type TaxReportingResourceTaxFormNzMrdpModel = z.infer<typeof TaxReportingResourceTaxFormNzMrdp>;

export const TaxReportingResourceTaxFormPayee = z.object({
'account': z.union([z.string(), z.lazy(() => Account)]),
'external_reference': z.string(),
'type': z.enum(['account', 'external_reference'])
});

export type TaxReportingResourceTaxFormPayeeModel = z.infer<typeof TaxReportingResourceTaxFormPayee>;

export const TaxReportingResourceTaxFormUs1099K = z.object({
'reporting_year': z.number().int()
});

export type TaxReportingResourceTaxFormUs1099KModel = z.infer<typeof TaxReportingResourceTaxFormUs1099K>;

export const TaxReportingResourceTaxFormUs1099Misc = z.object({
'reporting_year': z.number().int()
});

export type TaxReportingResourceTaxFormUs1099MiscModel = z.infer<typeof TaxReportingResourceTaxFormUs1099Misc>;

export const TaxReportingResourceTaxFormUs1099Nec = z.object({
'reporting_year': z.number().int()
});

export type TaxReportingResourceTaxFormUs1099NecModel = z.infer<typeof TaxReportingResourceTaxFormUs1099Nec>;

export const TaxForm: z.ZodType<TaxFormModel> = z.object({
'au_serr': TaxReportingResourceTaxFormAuSerr.optional(),
'ca_mrdp': TaxReportingResourceTaxFormCaMrdp.optional(),
'corrected_by': z.union([z.string(), z.lazy(() => TaxForm)]),
'created': z.number().int(),
'eu_dac7': TaxReportingResourceTaxFormEuDac7.optional(),
'filing_statuses': z.array(TaxReportingResourceTaxFormFilingStatus),
'gb_mrdp': TaxReportingResourceTaxFormGbMrdp.optional(),
'id': z.string(),
'livemode': z.boolean(),
'nz_mrdp': TaxReportingResourceTaxFormNzMrdp.optional(),
'object': z.enum(['tax.form']),
'payee': TaxReportingResourceTaxFormPayee,
'type': z.enum(['au_serr', 'ca_mrdp', 'eu_dac7', 'gb_mrdp', 'nz_mrdp', 'us_1099_k', 'us_1099_misc', 'us_1099_nec']),
'us_1099_k': TaxReportingResourceTaxFormUs1099K.optional(),
'us_1099_misc': TaxReportingResourceTaxFormUs1099Misc.optional(),
'us_1099_nec': TaxReportingResourceTaxFormUs1099Nec.optional()
});

export const TaxFormUpdated = z.object({
'object': z.lazy(() => TaxForm)
});

export type TaxFormUpdatedModel = z.infer<typeof TaxFormUpdated>;
...
export const TerminalConfigurationConfigurationResourceReaderSecurityConfig = z.object({
'admin_menu_passcode': z.string()
});

export type TerminalConfigurationConfigurationResourceReaderSecurityConfigModel = z.infer<typeof TerminalConfigurationConfigurationResourceReaderSecurityConfig>;
...
'reader_security': TerminalConfigurationConfigurationResourceReaderSecurityConfig.optional(),
...
export const TerminalReaderCollectedDataResourceMagstripeData = z.object({
'data': z.string()
});

export type TerminalReaderCollectedDataResourceMagstripeDataModel = z.infer<typeof TerminalReaderCollectedDataResourceMagstripeData>;

export const TerminalReaderCollectedData = z.object({
'created': z.number().int(),
'id': z.string(),
'livemode': z.boolean(),
'magstripe': z.union([TerminalReaderCollectedDataResourceMagstripeData]),
'object': z.enum(['terminal.reader_collected_data']),
'type': z.enum(['magstripe'])
});

export type TerminalReaderCollectedDataModel = z.infer<typeof TerminalReaderCollectedData>;
...
export const TreasuryOutboundTransfersResourceAchNetworkDetails = z.object({
'addenda': z.string()
});

export type TreasuryOutboundTransfersResourceAchNetworkDetailsModel = z.infer<typeof TreasuryOutboundTransfersResourceAchNetworkDetails>;

export const TreasuryOutboundTransfersResourceNetworkDetails = z.object({
'ach': z.union([TreasuryOutboundTransfersResourceAchNetworkDetails]).optional(),
'type': z.enum(['ach'])
});

export type TreasuryOutboundTransfersResourceNetworkDetailsModel = z.infer<typeof TreasuryOutboundTransfersResourceNetworkDetails>;
...
'livemode': z.boolean(),
'metadata': z.record(z.string(), z.string()),
'network_details': z.union([TreasuryOutboundTransfersResourceNetworkDetails]).optional(),
...
export const TreasuryReceivedCreditsResourceAchNetworkDetails = z.object({
'addenda': z.string()
});

export type TreasuryReceivedCreditsResourceAchNetworkDetailsModel = z.infer<typeof TreasuryReceivedCreditsResourceAchNetworkDetails>;

export const TreasuryReceivedCreditsResourceNetworkDetails = z.object({
'ach': z.union([TreasuryReceivedCreditsResourceAchNetworkDetails]).optional(),
'type': z.enum(['ach'])
});

export type TreasuryReceivedCreditsResourceNetworkDetailsModel = z.infer<typeof TreasuryReceivedCreditsResourceNetworkDetails>;
...
'network_details': z.union([TreasuryReceivedCreditsResourceNetworkDetails]).optional(),
...
'issuing_transaction': z.string(),
'payout': z.string(),
'received_credit_capital_withholding': z.string().optional()
});

export type TreasuryReceivedDebitsResourceLinkedFlowsModel = z.infer<typeof TreasuryReceivedDebitsResourceLinkedFlows>;

export const TreasuryReceivedDebitsResourceAchNetworkDetails = z.object({
'addenda': z.string()
});

export type TreasuryReceivedDebitsResourceAchNetworkDetailsModel = z.infer<typeof TreasuryReceivedDebitsResourceAchNetworkDetails>;

export const TreasuryReceivedDebitsResourceNetworkDetails = z.object({
'ach': z.union([TreasuryReceivedDebitsResourceAchNetworkDetails]).optional(),
'type': z.enum(['ach'])
});

export type TreasuryReceivedDebitsResourceNetworkDetailsModel = z.infer<typeof TreasuryReceivedDebitsResourceNetworkDetails>;
...
'network_details': z.union([TreasuryReceivedDebitsResourceNetworkDetails]).optional(),
...
'bank': z.enum(['evolve', 'fifth_third', 'goldman_sachs']).optional(),
'requested': z.boolean(),
'status': z.enum(['active', 'pending', 'restricted']),
'status_details': z.array(TreasuryFinancialAccountsResourceTogglesSettingStatusDetails)
});
